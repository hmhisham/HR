...
class Jobleaver extends Component
{
  ...
  public $search = '';
  public $workers = [];
  public $worker, $computer_number, $department, $full_name;
  ...
  public function render()
  {
    ...
    $Jobleavers = Jobleavers::join('workers', 'jobleavers.computer_number', '=', 'workers.computer_number')
      ->where(function ($query) use ($JobleaverSearch) {
        $query->where('jobleavers.computer_number', 'LIKE', $JobleaverSearch)
  ...
  {
    $this->reset(['department', 'user_id', 'added_service', 'computer_number', 'job_leaving_type', 'issuing_authority', 'appointment_date', 'disconnection_date', 'return_date', 'disconnection_duration', 'ministerial_order_number', 'ministerial_order_date', 'added_service_letter_number', 'added_service_letter_date', 'notes']);
  ...
  public function GetJobleaver($JobleaverId)
  {
    ...
    $this->computer_number = $this->Jobleaver->computer_number;
  ...
  public function update()
  {
    ...
    $this->validate([
      ...
      'computer_number' => 'required:jobleavers',
