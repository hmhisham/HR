...
class Dispatc extends Component
{
  ...
  public $user_id, $computer_number, $country_status, $dispatch_subject, $funding_agency, $dispatch_location, $resident_agency, $travel_date, $travel_days, $actual_dispatch_days, $start_date, $ministerial_order_number, $ministerial_order_date, $notes;
  ...
  public function render()
  {
    ...
    $Dispatch = Dispatch::join('workers', 'dispatch.computer_number', '=', 'workers.computer_number')
      ->where(function ($query) use ($DispatchSearch) {
        $query->where('dispatch.computer_number', 'LIKE', $DispatchSearch)
  ...
  public function store()
  {
    ...
    $this->reset(['department', 'user_id', 'computer_number', 'country_status', 'dispatch_subject', 'funding_agency', 'dispatch_location', 'resident_agency', 'travel_date', 'travel_days', 'actual_dispatch_days', 'start_date', 'ministerial_order_number', 'ministerial_order_date', 'notes']);
  ...
  public function Getdispatc($dispatcId)
  {
    ...
    $this->computer_number = $this->dispatc->computer_number;
  ...
  public function update()
  {
    ...
    $this->validate([
      ...
      'computer_number' => 'required:dispatch',
