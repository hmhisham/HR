...
class Coache extends Component
{
    ...
    public function store()
    {
        ...
        $this->validate([
            ...
            'calculator_number.required' => 'حقل calculator_number مطلوب',
            'name_coache.required' => 'حقل name_coache مطلوب',
            'education.required' => 'حقل education مطلوب',
            'phone_number.required' => 'حقل phone_number مطلوب',
            'institution.required' => 'حقل institution مطلوب',
            'training_field.required' => 'حقل training_field مطلوب',
