...
class Coache extends Component
{
  ...
  public $user_id, $computer_number, $name_coache, $education, $phone_number, $institution, $training_field, $email, $notes;
  ...
  public function render()
  {
    ...
    $Coaches = Coaches::where('user_id', 'LIKE', $CoacheSearch)
      ->orWhere('computer_number', 'LIKE', $CoacheSearch)
  ...
  public function GetCoache($CoacheId)
  {
    ...
    $this->computer_number = $this->Coache->computer_number;
  ...
  public function update()
  {
    ...
    $this->validate([
      ...
      'computer_number' => 'required:coaches',
