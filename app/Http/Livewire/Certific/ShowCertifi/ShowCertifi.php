...
class ShowCertifi extends Component
{
  ...
  public $user_id, $computer_number, $document_number, $document_date, $certificates_id, $authenticity_number, $authenticity_date, $graduations_id, $specialization_id, $graduation_year, $specialtys_id, $precises_id, $specializationclassification_id, $grade, $estimate, $duration, $issuing_country, $notes, $status;
  ...
  {
    $this->reset(['computer_number', 'document_number', 'document_date', 'certificates_id', 'authenticity_number', 'authenticity_date', 'graduations_id', 'specialization_id', 'graduation_year', 'specialtys_id', 'precises_id', 'specializationclassification_id', 'grade', 'estimate', 'duration', 'issuing_country', 'notes', 'status']);
  ...
  public function update()
  {
    ...
    if ($this->certificateFilePreview) {
      ...
      if (file_exists(public_path('storage/Certific/' . $this->computer_number . '/' . $this->certifi->certificate_file))) {
        unlink(public_path('storage/Certific/' . $this->computer_number . '/' . $this->certifi->certificate_file));
      }

      $this->Edit_certificate_file->store($this->computer_number, 'Certific');
    ...
    if ($this->validitySsuanceFilePreview) {
      ...
      if (file_exists(public_path('storage/Certific/' . $this->computer_number . '/' . $this->certifi->validity_ssuance_certificate_file))) {
        unlink(public_path('storage/Certific/' . $this->computer_number . '/' . $this->certifi->validity_ssuance_certificate_file));
      }

      $this->Edit_validity_ssuance_certificate_file->store($this->computer_number, 'Certific');
