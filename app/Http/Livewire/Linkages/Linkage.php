...
class Linkage extends Component
{
    ...
    {
        $this->resetValidation();
         $this->validate(['Linkages_name' => 'required' ,

                 ], [
                'Linkages_name.required' => 'حقل  مطلوب',  ]);
...
'Linkages_name'=> $this->Linkages_name,
 ...
 public function update()
    {
        $this->resetValidation();
         $this->validate(['Linkages_name' => 'required:linkages' ,

                 ], [
                'Linkages_name.required' => 'حقل الاسم مطلوب', ]);
                                 
             $Linkages = Linkages::find($this->LinkageId);     $Linkages->update([
'Linkages_name'=> $this->Linkages_name,
