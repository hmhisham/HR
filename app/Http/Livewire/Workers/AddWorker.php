...
class AddWorker extends Component
{
  ...
  public $WorkerSearch = '';
  public $computer_number, $employee_number, $paper_folder_number, $first_name, $father_name, $grandfather_name, $great_grandfather_name, $surname, $full_name;
  ...
  public function AddWorker()
  {
    $this->resetValidation();
    $this->validate([
      'computer_number' => 'required|unique:workers,computer_number',
      ...
      'computer_number.unique' => 'لقد تم أخذ رقم الحاسبة بالفعل',
