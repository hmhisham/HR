...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('workers', function (Blueprint $table) {
            ...
            $table->string('surname', 15)->nullable()->comment('اللقب');
            $table->string('full_name', 15)->nullable()->comment('الاسم الكامل');
            $table->string('mother_name', 15)->nullable()->comment('اسم الام');
            $table->string('maternal_grandfather_name', 15)->nullable()->comment('اسم والد الام');
            $table->string('maternal_great_grandfather_name', 15)->nullable()->comment('اسم جد الام');
            $table->string('maternal_surname', 15)->nullable()->comment('لقب الام');
            $table->string('mother_full_name', 15)->nullable()->comment('اسم الام الكامل');
            ...
            $table->string('locality', 15)->nullable()->comment('المحلة');
            $table->string('phone_number', 15)->nullable()->comment('رقم الهاتف');
            $table->string('employee_id_number', 15)->nullable()->nullable()->comment('رقم هوية الموظف');
            ...
            $table->string('birth_place', 15)->nullable()->comment('محل الولادة');
