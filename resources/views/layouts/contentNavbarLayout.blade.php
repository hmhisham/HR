...
<<<<<<< HEAD
                            <li class="menu-item {{ request()->is('Provinces', 'Plots', 'Show-Plot/*', 'Boycotts', 'Bonds', 'Bond-Show/*', 'Property', 'Propertytypes') ? 'open active' : '' }}">
=======
                            <li
                                class="menu-item {{ request()->is('Provinces', 'Plots', 'Plot-Show/*', 'Boycotts', 'Bonds', 'Bond-Show/*', 'Property') ? 'open active' : '' }}">
>>>>>>> 1e5d1b39d7ef82cf3bb84a3baf206d61338b6fb6
                                <a href="javascript:void(0);" class="menu-link menu-toggle">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class='menu-icon tf-icons' style="width: 22px;"><title>land-plots-marker</title><path d="M4 2H20C21.1 2 22 2.9 22 4V10H10V20H14.55C14.73 20.3 14.91 20.58 15.09 20.84C15.38 21.27 15.66 21.66 15.92 22H4C2.9 22 2 21.1 2 20V4C2 2.9 2.9 2 4 2M8 4H4V14H8V4M4 16V20H8V16H4M10 8H20V4H10V8M18.5 22C18.5 22 17.92 21.35 17.23 20.41C17.14 20.28 17.04 20.14 16.94 20C16 18.66 15 16.89 15 15.5C15 13.6 16.6 12 18.5 12C19.03 12 19.54 12.13 20 12.35C21.17 12.92 22 14.13 22 15.5C22 17.04 20.77 19.04 19.77 20.41C19.08 21.35 18.5 22 18.5 22M17.3 15.6C17.3 16.2 17.8 16.8 18.5 16.8C19.2 16.8 19.8 16.2 19.7 15.6C19.7 15 19.1 14.4 18.5 14.4C17.9 14.4 17.3 14.9 17.3 15.6Z" /></svg>
