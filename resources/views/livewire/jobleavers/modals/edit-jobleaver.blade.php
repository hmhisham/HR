<!-- Edite Jobleaver Modal -->
<div wire:ignore.self class="modal fade" id="editjobleaverModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <div wire:loading.remove>
                    <form id="editJobleaverModalForm" autocomplete="off">
                        <div class="row row-cols-1">
                            <div class="col mb-3">
                                ...
                                <div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <select wire:model.defer='job_leaving_type'
                                                id="modalJobleaversjob_leaving_type"
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            ...
                                            <label for="modalJobleaversministerial_order_number">رقم الامر
                                                الوزاري</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            ...
                                            <label for="modalJobleaversministerial_order_date">تاريخ الامر
                                                الوزاري</label>
                                        </div>
