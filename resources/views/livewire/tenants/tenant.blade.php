                    ...
                    <tr>
                        ...
                        <th class="text-center">
                            <input type="text" wire:model.debounce.300ms="search.phone"
                                class="text-center form-control form-control-sm" placeholder="رقم الهاتف">
                        </th>

                        <th class="text-center">
                            <input type="text" wire:model.debounce.300ms="search.email"
                                class="text-center form-control form-control-sm" placeholder="البريد الإلكتروني">
                        </th>

                        <th class="text-center">
                            <input type="text" wire:model.debounce.300ms="search.address"
                                class="text-center form-control form-control-sm" placeholder="العنوان">
                        </th>
