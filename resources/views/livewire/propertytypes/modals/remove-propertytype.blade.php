<!-- Remove Propertytype Modal -->
<div wire:ignore.self class="modal fade" id="removepropertytypeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">حذف جنس العقار</h3>
                    <p>نافذة الحذف</p>
                </div>
                <hr class="mt-n2">
                ...
                <div wire:loading.remove>
                    <form id="removePropertytypeModalForm" onsubmit="return false" autocomplete="off">
                        <div class="row">
                            <div class="col text-center">
                                <div class="">
                                    <label for="modalPropertytypetype_name">اسم النوع</label>
                                    <div class="form-control-plaintext mt-n2">{{ $type_name }}</div>
                                </div>
                            </div>
                        </div>
                        <hr class="my-0">
