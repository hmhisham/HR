<!-- Add Propertytyperente Modal -->
<div wire:ignore.self class="modal fade" id="addpropertytyperenteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <form id="addpropertytyperenteModalForm" autocomplete="off">
                            ...
                            <div Class="row">
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <label for="modalPropertytyperenteproperty_type_rented">نوع عقار المؤجر</label>
                                    </div>
