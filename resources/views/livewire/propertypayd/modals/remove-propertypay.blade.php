...
<!-- Remove Propertypay Modal -->
<div wire:ignore.self class="modal fade" id="removepropertypayModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">\ الدفعحذف</h3>
                    <p>نافذة الحذف</p>
                </div>
                <hr class="mt-n2">
                <h5 wire:loading wire:target="GetPropertypay" wire:loading.class="d-flex justify-content-center text-primary">جار معالجة البيانات...</h5>
                ...
                <form id="removePropertypayModalForm" onsubmit="return false" autocomplete="off">
                ...
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='user_id' type="text" id="modalPropertypayuser_id" placeholder="رقم المستخدم"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='receipt_number' type="text" id="modalPropertypayreceipt_number" placeholder="رقم الإيصال"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='receipt_file' type="text" id="modalPropertypayreceipt_file" placeholder="ملف الإيصال"
