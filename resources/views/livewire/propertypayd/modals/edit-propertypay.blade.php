        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">تعديل ايصال دفع</h3>
                </div>

                <hr class="mt-n2">

                <h5 wire:loading wire:target="GetPropertypay" wire:loading.class="d-flex justify-content-center">
                    جار حفظ البيانات...
                </h5>
                ...
                <form id="addpropertypayModalForm" autocomplete="off">
                    <section wire:loading.remove wire:target="storeو GetPropertypay" class="section-py first-section-pt mt-n4">
                        <div class="container">
                            <div class="px-3">
                                <div class="row">
                                            ...
                                            <div class="col-md mb-md-0 mb-3">
                                                <div class="form-floating form-floating-outline">
                                                    <input wire:model.defer='receipt_number' type="text"
                                                        id="editReceiptNumber" placeholder="رقم الإيصال"
                                        ...
                                        {{-- <div class="d-flex justify-content-between align-items-center mt-3">
                                            ...
                                            <div wire:loading.remove wire:target='receipt_file'>
                                                @if ($filePreview)
                                                    ...
                                                    @endif
                                                @endif
                                                @if ($receipt_file and $filePreview == '')
                                                    @if (pathinfo($receipt_file, PATHINFO_EXTENSION) == strtolower('pdf'))
                                                        <iframe src="{{ asset('storage/Property/Payment-Receipts/' . $receipt_file) }}"
                                                            class="mt-3 " style="height: 350px; width: 100%"></iframe>
                                                    @else
                                                        <img src="{{ asset('storage/Property/Payment-Receipts/' . $receipt_file) }}"
                                    ...
                                    <div class="text-center col-12 demo-vertical-spacing mb-n4">
                                        <button wire:click='update' wire:loading.attr="disabled" type="button" {{ $RemainingAmount < 0 ? 'disabled':'' }}
