<div class="mt-n4">
    <h4 class="mb-2">
        <span class="text-muted fw-light">الموارد البشرية <span class="mdi mdi-chevron-left mdi-24px"></span></span> عرض شهادات السيد/ة : {{ $Worker->full_name }}
    </h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @can('branc-edit')
                                    <button wire:click="Getcertifi({{ $Certific->id }})" class="p-0 px-1 btn btn-text-success waves-effect"
