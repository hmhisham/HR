                        ...
                        <div class="row">
                            <div class="col text-center">
                                <div class="">
                                    ...
                                    <div class="form-control-plaintext mt-n2">{{ $this->scaleas_salary_grade }}</div>
                                </div>
                            </div>
                            <div class="col text-center">
                                <div class="">
                                    <label for="modalscaleasscaleas_salary_stage">مرحلة الراتب</label>
                                    <div class="form-control-plaintext mt-n2">{{ $this->scaleas_salary_stage }}</div>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col text-center">
                                <div class="text-danger">
                                    ...
                                    <div class="form-control-plaintext mt-n2">{{ $this->scaleas_salary }}</div>
                                </div>
                            </div>
                        </div>
                        <hr class="my-0">
