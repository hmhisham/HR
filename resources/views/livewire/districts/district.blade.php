    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    @can('district-create')
                    <button wire:click='AddDistrictModalShow' class="mb-3 add-new btn btn-primary mb-md-0" data-bs-toggle="modal" data-bs-target="#adddistrictModal">أضــافــة</button>
                ...
                <tr>
                    ...
                    <td Class="text-center">
                        <div class="btn-group" role="group" aria-label="First group">
                            @can('district-edit')
                            <button wire:click="GetDistrict({{ $District->id }})" class="p-0 px-1 btn btn-outline-success waves-effect" data-bs-toggle="modal" data-bs-target="#editdistrictModal">
                                <i class="tf-icons mdi mdi-pencil fs-3"></i>
                            </button>
                            @endcan
                            @can('district-delete')
                            <button wire:click="GetDistrict({{ $District->id }})" class="p-0 px-1 btn btn-outline-danger waves-effect {{ $District->active ? 'disabled' : '' }}" data-bs-toggle="modal" data-bs-target="#removedistrictModal">
