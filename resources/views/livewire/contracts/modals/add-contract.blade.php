        ...
        <form id="addcontractModalForm" autocomplete="off">
          <div class="row g-1">
            ...
            <div class="row g-2">
              ...
              <div class="mb-2 col">
                <div class="form-floating form-floating-outline">
                  <input wire:model.defer='tenant_name' type="text" id="modalContracttenant_name" placeholder="اسم المستأجر" class="form-control @error('tenant_name') is-invalid is-filled @enderror" />
