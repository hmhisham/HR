...
<div class="mt-n4">
    <h4 class="mb-1 fw-semiboyld">قائمة \ عقد الايجار</h4>
    <div class="card">
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    @can('contract-create')
                        <button wire:click='AddContractModalShow' class="mb-3 add-new btn btn-primary mb-md-0"
                            data-bs-toggle="modal" data-bs-target="#addcontractModal">أضــافــة</button>
...
<th class="text-center">العملية</th> </tr>
   ...
   <th class="text-center">
                                <input type="text" wire:model.debounce.300ms="search.document_contract_number"
                                    class="form-control text-center" placeholder="رقم العقد في المستند">
                            </th>
                        
  <th class="text-center">
                                <input type="text" wire:model.debounce.300ms="search.generated_contract_number"
                                    class="form-control text-center" placeholder="رقم العقد المنشأ">
                            </th>
                        
  <th class="text-center">
                                <input type="text" wire:model.debounce.300ms="search.start_date"
                                    class="form-control text-center" placeholder="تاريخ بداية العقد">
                            </th>
                        
  <th class="text-center">
                                <input type="text" wire:model.debounce.300ms="search.end_date"
                                    class="form-control text-center" placeholder="تاريخ انتهاء العقد">
                            </th>
                        
  <th class="text-center">
                                <input type="text" wire:model.debounce.300ms="search.tenant_name"
                                    class="form-control text-center" placeholder="اسم المستأجر">
                            </th>
                        
  <th class="text-center">
                                <input type="text" wire:model.debounce.300ms="search.annual_rent_amount"
                                    class="form-control text-center" placeholder="مبلغ التأجير للسنة الواحدة">
                            </th>
 ...
 <td class="text-center">{{ $Contract->notes}}</td>
                                  ...
                                  <td class="text-center">
                                     <div class="btn-group" role="group" aria-label="First group">
                                         ...
                                         @can('contract-delete')
                                             <button wire:click="GetContract({{ $Contract->id }})"
                                                 class="p-0 px-1 btn btn-outline-danger waves-effect {{ $Contract->active ? 'disabled' : '' }}"
                                                 data-bs-toggle = "modal" data-bs-target="#removecontractModal">
