...
<div wire:ignore.self class="modal fade" id="addRealitieToPlotModal" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <div Class="row">
                                        ...
                                        <div class="mb-3 col">
                                            <div class="form-floating form-floating-outline">
                                                <select wire:model.defer="mortgage_notes"
                                                    id="modalRealitiemortgage_notes"
                                    ...
                                    <div Class="row">
                                        <div class="mb-3 col">
                                            <div class="form-floating form-floating-outline">
                                                <input wire:model.defer='count' type="text"
                                                    id="modalRealitiecount" placeholder="العدد"
                                        ...
                                        <div class="mb-3 col">
                                            <div class="form-floating form-floating-outline">
                                                <input wire:ignore wire:model.defer='date' type="date"
                                                    id="addDate" placeholder="التاريخ"
                                        ...
                                        <div class="mb-3 col">
                                            <div class="form-floating form-floating-outline">
                                                <select wire:model.defer='registered_office'
                                                    ...
                                                    <option value="مديرية التسجيل العقاري الاولى">مديرية التسجيل
                                                        العقاري الاولى
                                                    </option>
                                                    ...
                                                    <option value="ملاحظية التسجيل العقاري في الثغر">ملاحظية التسجيل
                                                        العقاري في
                                                        الثغر</option>
                                                    <option value="ملاحظية التسجيل العقاري في الشهيد عز الدين سليم">
                                                        ملاحظية
                                                ...
                                                <label for="modalRealitieregistered_office">الدائرة المسجل
                                                    لديها</label>
                                            </div>
                                        ...
                                        <div class="mb-3 col">
                                            <div class="form-floating form-floating-outline">
                                                <input wire:model.defer='notes' type="text"
                                                    id="modalRealitienotes" placeholder="ملاحظات"
