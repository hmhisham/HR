        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='user_id' type="text" id="modalPlacementuser_id" placeholder="رقم المستخدم"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='worker_id' type="text" id="modalPlacementworker_id" placeholder="الاسم"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='linkage_id' type="text" id="modalPlacementlinkage_id" placeholder="الارتباط"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='section_id' type="text" id="modalPlacementsection_id" placeholder="القسم"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='branch_id' type="text" id="modalPlacementbranch_id" placeholder="الشعبة"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='unit_id' type="text" id="modalPlacementunit_id" placeholder="الوحدة"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='placement_order_number' type="text" id="modalPlacementplacement_order_number" placeholder="رقم أمر التنسيب"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='placement_order_date' type="date" id="modalPlacementplacement_order_date" placeholder="تاريخ أمر التنسيب"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='release_date' type="date" id="modalPlacementrelease_date" placeholder="تاريخ الانفكاك"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='start_date' type="date" id="modalPlacementstart_date" placeholder="تاريخ المباشرة"
