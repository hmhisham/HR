        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">تعديل معلومات الموظف</h3>
                    <p>نافذة التعديل</p>
                </div>
                <hr class="mt-n2">
                        ...
                        <div class="row row-cols-1">
                            <div class="col mb-3">
                                '<Div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='user_id' type="text" id="modalWorkeruser_id"
                                                placeholder=""
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='employee_number' type="text"
                                                id="modalWorkeremployee_number" placeholder="الرقم الوظيفي"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='paper_folder_number' type="text"
                                                id="modalWorkerpaper_folder_number" placeholder="رقم الاضبارة الورقية"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='first_name' type="text"
                                                id="modalWorkerfirst_name" placeholder="الاسم الاول"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='father_name' type="text"
                                                id="modalWorkerfather_name" placeholder="اسم الاب"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='grandfather_name' type="text"
                                                id="modalWorkergrandfather_name" placeholder="اسم الجد"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='great_grandfather_name' type="text"
                                                id="modalWorkergreat_grandfather_name" placeholder="اسم والد الجد"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='surname' type="text" id="modalWorkersurname"
                                                placeholder="اللقب"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='full_name' type="text"
                                                id="modalWorkerfull_name" placeholder="الاسم الكامل"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='mother_name' type="text"
                                                id="modalWorkermother_name" placeholder="اسم الام"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='maternal_grandfather_name' type="text"
                                                id="modalWorkermaternal_grandfather_name" placeholder="اسم والد الام"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='maternal_great_grandfather_name' type="text"
                                                id="modalWorkermaternal_great_grandfather_name"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='maternal_surname' type="text"
                                                id="modalWorkermaternal_surname" placeholder="لقب الام"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='mother_full_name' type="text"
                                                id="modalWorkermother_full_name" placeholder="اسم الام الكامل"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='wife_name' type="text"
                                                id="modalWorkerwife_name" placeholder="اسم الزوجة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='district_id' type="text"
                                                id="modalWorkerdistrict_id" placeholder="القضاء"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='area_id' type="text" id="modalWorkerarea_id"
                                                placeholder="الناحية"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='locality' type="text"
                                                id="modalWorkerlocality" placeholder="المحلة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='phone_number' type="text"
                                                id="modalWorkerphone_number" placeholder="رقم الهاتف"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='employee_id_number' type="text"
                                                id="modalWorkeremployee_id_number" placeholder="رقم هوية الموظف"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='department_name' type="text"
                                                id="modalWorkerdepartment_name" placeholder="اسم الدائرة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='blood_type' type="text"
                                                id="modalWorkerblood_type" placeholder="صنف الدم"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='email' type="text" id="modalWorkeremail"
                                                placeholder="الايميل"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='birth_date' type="text"
                                                id="modalWorkerbirth_date" placeholder="تاريخ التولد"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='birth_place' type="text"
                                                id="modalWorkerbirth_place" placeholder="محل الولادة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='governorate_id' type="text"
                                                id="modalWorkergovernorate_id" placeholder="المحافظة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='marital_status' type="text"
                                                id="modalWorkermarital_status" placeholder="الحالة الزوجية"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='religion' type="text"
                                                id="modalWorkerreligion" placeholder="الديانة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='gender' type="text" id="modalWorkergender"
                                                placeholder="الجنس"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='children_count' type="text"
                                                id="modalWorkerchildren_count" placeholder="عدد الاطفال"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='civil_status_identity_number' type="text"
                                                id="modalWorkercivil_status_identity_number"
                                                placeholder="رقم هوية الاحوال"
                                                class="form-control @error('civil_status_identity_number') is-invalid is-filled @enderror" />
                                            <label for="modalWorkercivil_status_identity_number">رقم هوية
                                                الاحوال</label>
                                        </div>
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='registration_number' type="text"
                                                id="modalWorkerregistration_number" placeholder="رقم السجل"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='record_number' type="text"
                                                id="modalWorkerrecord_number" placeholder="رقم الصحيفة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='issue_date_civil_status' type="text"
                                                id="modalWorkerissue_date_civil_status" placeholder="تاريخ الاصدار"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='issuing_authority_civil_status' type="text"
                                                id="modalWorkerissuing_authority_civil_status"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='nationality_certificate_number' type="text"
                                                id="modalWorkernationality_certificate_number"
                                                placeholder="رقم شهادة الجنسية"
                                                class="form-control @error('nationality_certificate_number') is-invalid is-filled @enderror" />
                                            <label for="modalWorkernationality_certificate_number">رقم شهادة
                                                الجنسية</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='wallet_number' type="text"
                                                id="modalWorkerwallet_number" placeholder="رقم المحفظة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='issue_date_nationality_certificate'
                                                type="text" id="modalWorkerissue_date_nationality_certificate"
                                                placeholder="تاريخ الاصدار"
                                                class="form-control @error('issue_date_nationality_certificate') is-invalid is-filled @enderror" />
                                            <label for="modalWorkerissue_date_nationality_certificate">تاريخ
                                                الاصدار</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='issuing_authority_nationality_certificate'
                                                type="text"
                                                id="modalWorkerissuing_authority_nationality_certificate"
                                                placeholder="جهة الاصدار"
                                                class="form-control @error('issuing_authority_nationality_certificate') is-invalid is-filled @enderror" />
                                            <label for="modalWorkerissuing_authority_nationality_certificate">جهة
                                                الاصدار</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='residence_card_number' type="text"
                                                id="modalWorkerresidence_card_number" placeholder="رقم بطاقة السكن"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='information_office' type="text"
                                                id="modalWorkerinformation_office" placeholder="مكتب المعلومات"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='organization_date' type="text"
                                                id="modalWorkerorganization_date" placeholder="تاريخ التنظيم"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='ration_card_number' type="text"
                                                id="modalWorkerration_card_number" placeholder="رقم البطاقة التموينية"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='ration_card_date' type="text"
                                                id="modalWorkerration_card_date" placeholder="تاريخها"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='national_card_number' type="text"
                                                id="modalWorkernational_card_number" placeholder="رقم البطاقة الوطنية"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='national_card_date' type="text"
                                                id="modalWorkernational_card_date" placeholder="تاريخها"
                                ...
                                <Div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='document_number' type="text"
                                                id="modalWorkerdocument_number" placeholder="رقم الوثيقة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='document_date' type="text"
                                                id="modalWorkerdocument_date" placeholder="تاريخ الوثيقة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='document_verification_number' type="text"
                                                id="modalWorkerdocument_verification_number"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='document_verification_date' type="text"
                                                id="modalWorkerdocument_verification_date"
                                ...
                                <Div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='graduation_institution_appointment'
                                                type="text" id="modalWorkergraduation_institution_appointment"
                                                placeholder="جهة تخرج التعيين"
                                                class="form-control @error('graduation_institution_appointment') is-invalid is-filled @enderror" />
                                            <label for="modalWorkergraduation_institution_appointment">جهة تخرج
                                                التعيين</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='specialization_appointment' type="text"
                                                id="modalWorkerspecialization_appointment"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_type' type="text"
                                                id="modalWorkerservice_type" placeholder="نوع الخدمة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_status' type="text"
                                                id="modalWorkerservice_status" placeholder="حالة الخدمة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='contract_type' type="text"
                                                id="modalWorkercontract_type" placeholder="نوع العقد"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_case_type' type="text"
                                                id="modalWorkerservice_case_type" placeholder="نوع حالة الخدمة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='general_specialization' type="text"
                                                id="modalWorkergeneral_specialization" placeholder="التخصص العام"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='precise_specialization' type="text"
                                                id="modalWorkerprecise_specialization" placeholder="التخصص الدقيق"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='degree' type="text" id="modalWorkerdegree"
                                                placeholder="د / و"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='position_title' type="text"
                                                id="modalWorkerposition_title" placeholder="العنوان الوظيفي"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='appointment_order_number' type="text"
                                                id="modalWorkerappointment_order_number" placeholder="رقم امر التعيين"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='appointment_date' type="text"
                                                id="modalWorkerappointment_date" placeholder="تاريخ التعيين"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='start_work_date' type="text"
                                                id="modalWorkerstart_work_date" placeholder="تاريخ المباشرة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='promotion_order' type="text"
                                                id="modalWorkerpromotion_order" placeholder="امر الترفيع"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='promotion_date' type="text"
                                                id="modalWorkerpromotion_date" placeholder="تاريخ الترفيع"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='entitlement_date' type="text"
                                                id="modalWorkerentitlement_date" placeholder="تاريخ الاستحقاق"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='increment_order' type="text"
                                                id="modalWorkerincrement_order" placeholder="امر العلاوة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='increment_date' type="text"
                                                id="modalWorkerincrement_date" placeholder="تاريخ العلاوة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='referral_order_number' type="text"
                                                id="modalWorkerreferral_order_number" placeholder="رقم امر الاحالة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='referral_order_date' type="text"
                                                id="modalWorkerreferral_order_date" placeholder="تاريخ رقم الاحالة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='termination_reason' type="text"
                                                id="modalWorkertermination_reason" placeholder="انهاء التعيين"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='transfer_date' type="text"
                                                id="modalWorkertransfer_date" placeholder="تاريخ النقل الينا"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='resumption_date' type="text"
                                                id="modalWorkerresumption_date" placeholder="المباشرة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='binding_authority' type="text"
                                                id="modalWorkerbinding_authority" placeholder="الارتباط"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='department' type="text"
                                                id="modalWorkerdepartment" placeholder="القسم"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='division' type="text"
                                                id="modalWorkerdivision" placeholder="الشعبة"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='unit' type="text" id="modalWorkerunit"
                                                placeholder="الوحدة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='secondment_authority' type="text"
                                                id="modalWorkersecondment_authority" placeholder="جهة التنسيب"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='notes' type="text" id="modalWorkernotes"
                                                placeholder="ملاحظات"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='position' type="text"
                                                id="modalWorkerposition" placeholder="المنصب"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='position_start_date' type="text"
                                                id="modalWorkerposition_start_date" placeholder="مباشرة المنصب"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='issuing_authority' type="text"
                                                id="modalWorkerissuing_authority" placeholder="جهة اصدار الامر"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_order_number' type="text"
                                                id="modalWorkerassignment_order_number" placeholder="رقم امر التكليف"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_order_date' type="text"
                                                id="modalWorkerassignment_order_date" placeholder="تاريخ امر التكليف"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_type' type="text"
                                                id="modalWorkerassignment_type" placeholder="نوع التكليف"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_status' type="text"
                                                id="modalWorkerassignment_status" placeholder="حالة التكليف"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_position' type="text"
                                                id="modalWorkersecond_position" placeholder="المنصب 2"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_position_start_date' type="text"
                                                id="modalWorkersecond_position_start_date"
                                ...
                                <Div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_issuing_authority' type="text"
                                                id="modalWorkersecond_issuing_authority"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_assignment_order_date' type="text"
                                                id="modalWorkersecond_assignment_order_date"
                                                placeholder="تاريخ امر التكليف 2"
                                                class="form-control @error('second_assignment_order_date') is-invalid is-filled @enderror" />
                                            <label for="modalWorkersecond_assignment_order_date">تاريخ امر التكليف
                                                2</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_assignment_type' type="text"
                                                id="modalWorkersecond_assignment_type" placeholder="نوع التكليف2"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_assignment_status' type="text"
                                                id="modalWorkersecond_assignment_status" placeholder="حالة التكليف2"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='end_date' type="text"
                                                id="modalWorkerend_date" placeholder="الى تاريخ"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_days' type="text"
                                                id="modalWorkerservice_days" placeholder="الخدمة يوم"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_months' type="text"
                                                id="modalWorkerservice_months" placeholder="الخدمة شهر"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_years' type="text"
                                                id="modalWorkerservice_years" placeholder="الخدمة سنة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_retirement_days' type="text"
                                                id="modalWorkertotal_retirement_days" placeholder="مجموع التقاعد يوم"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_retirement_months' type="text"
                                                id="modalWorkertotal_retirement_months"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_retirement_years' type="text"
                                                id="modalWorkertotal_retirement_years"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_actual_days' type="text"
                                                id="modalWorkertotal_actual_days" placeholder="مجموع الفعلية يوم"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_actual_months' type="text"
                                                id="modalWorkertotal_actual_months" placeholder="مجموع الفعلية شهر"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_actual_years' type="text"
                                                id="modalWorkertotal_actual_years" placeholder="مجموع الفعلية سنة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_college_days' type="text"
                                                id="modalWorkertotal_college_days" placeholder="مجموع الكلية يوم"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_college_months' type="text"
                                                id="modalWorkertotal_college_months" placeholder="مجموع الكلية شهر"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_college_years' type="text"
                                                id="modalWorkertotal_college_years" placeholder="مجموع الكلية سنة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='mypassword' type="text"
                                                id="modalWorkermypassword" placeholder="كلمة السر"
