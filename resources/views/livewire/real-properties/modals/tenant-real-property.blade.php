...
<div wire:ignore.self class="modal fade" id="tenantRealPropertyModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="p-4 modal-content p-md-5">
            <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">تأجير السند العقاري</h3>
                </div>
                ...
                <div wire:loading.remove wire:target="update, GetRealProperty">
                    ...
                    <form id="editRealitieModalForm" autocomplete="off">
                        <div class="row">
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model.defer='from_date' type="text" id="tenant_from_date"
                            ...
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model.defer='to_date' type="text" id="tenant_to_date"
                            ...
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model.defer='number_of_months' type="text" id="number_of_months"
                                        placeholder="عدد الاشهر" readonly disabled
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model.defer='insurance_amount' wire:keyup='percentAmount' type="text"
                                        onkeypress="return onlyNumberKey(event)" id="insurance_amount"
                                        placeholder="مبلغ التثمين"
                            ...
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model.defer='sale_amount' wire:keyup='percentAmount' type="text"
                                        onkeypress="return onlyNumberKey(event)" id="sale_amount"
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model.defer='alert_duration' type="text" id="alert_duration"
                                        placeholder="مدة التنبيه (شهر)" onkeypress="return onlyNumberKey(event)"
                        ...
                        <div class="text-center col-12 demo-vertical-spacing mb-n4">
                            <button wire:click='tenant' wire:loading.attr="disabled" type="button"
