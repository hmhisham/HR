<div class="mt-n4">
    <h4 class="mb-1 fw-semiboyld">قائمة \ البريد الالكتروني</h4>
    <div class="card">
                ...
                <table class="table">
                    <thead class="table-light">
                        ...
                        <tr>
                            ...
                            <th class="text-center">
                                <input type="text" wire:model.debounce.300ms="search.notes" class="form-control text-center"
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="First group">
                                        ...
                                        @can('emaillist-delete')
                                            <button wire:click="Getemaillist({{ $emaillist->id }})"
                                                class="p-0 px-1 btn btn-outline-danger waves-effect {{ $emaillist->active ? 'disabled' : '' }}"
