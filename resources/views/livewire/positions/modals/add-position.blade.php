            ...
            <div class="modal-body p-md-0">
                ...
                <form id="addpositionModalForm" autocomplete="off">
                    ...
                    <div Class="row">
                        ...
                        <div class="mb-3 col">
                            <div class="form-floating form-floating-outline">
                                <input wire:model.defer='position_order_date' type="date" id="addposition_order_date"
                                    placeholder="تاريخ أمر التكليف"
                    ...
                    <div Class="row">
                        ...
                        <div class="mb-3 col">
                            <div class="form-floating form-floating-outline">
                                <select wire:model.defer='commissioning_statu' id="modalPositioncommissioning_statu"
