            ...
            <td class="text-center">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $Propertyfolde->id }}">
                  ...
                  @endcan
                  <li>
                    <a class="dropdown-item {{ $Propertyfolde->active ? 'disabled' : '' }}" href="{{ route('Contracts.index', ['property_folder_id' => $Propertyfolde->id, 'propertyfolder' => $Propertyfolde]) }}">
...
<a class="dropdown-item {{ $Propertyfolde->active ? 'disabled' : '' }}" href="{{ route('Rental.index', ['property_folder_id' => $Propertyfolde->id]) }}">
                  ...
                  <li>
                    <a class="dropdown-item {{ $Propertyfolde->active ? 'disabled' : '' }}" href="{{ route('Valuation.index', ['property_folder_id' => $Propertyfolde->id]) }}"> 
