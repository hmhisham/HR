                        ...
                        <div class="row row-cols-1">
                            <div class="col mb-3">
                                ...
                                <div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='order_date' type="date"
                                                id="modalHolidayorder_date" placeholder="تاريخ الامر الاداري"
                                ...
                                <div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='days_count' type="text"
                                                id="modalHolidaydays_count" placeholder="عدد الايام"
                                ...
                                <div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer="file_path" type="file"
                                                id="modalHolidayfile_path" placeholder="الملف" accept="pdf,image/*"
