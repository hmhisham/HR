<div class="mt-n4">
    <h4 class="mb-2">
        <span class="text-muted fw-light">الإعدادات <span class="mdi mdi-chevron-left mdi-24px"></span></span> التحصيل الدراسي
    </h4>
    <Div Class="card">
        <div class="card">
                                ...
                                <td Class="text-center">
                                    <div class="btn-group" role="group" aria-label="First group">
                                        ...
                                        @can('certificate-delete')
                                            <button wire:click="GetCertificate({{ $Certificate->id }})"
                                                class="p-0 px-1 btn btn-text-danger waves-effect {{ $Certificate->active ? 'disabled' : '' }}"
