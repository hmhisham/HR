        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">حذف المجال التدريبي</h3>
                    <p>نافذة الحذف</p>
                </div>
                <hr class="mt-n2">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <div class="text-danger">
                                    <label for="modalTrainingtrainings_name">مجال الندريب</label>
                                    <div class="form-control-plaintext mt-n2">{{ $this->trainings_name }}</div>
                                </div>
                            </div>
                        </div>
                        <hr class="my-0">
