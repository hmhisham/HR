    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <h5 wire:loading wire:target="GetBond" wire:loading.class="d-flex justify-content-center text-primary">جار معالجة البيانات...</h5>
                ...
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='boycott_id' type="text" id="modalBondboycott_id" placeholder="رقم المقاطعة"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='part_number' type="text" id="modalBondpart_number" placeholder="رقم القطعة"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='property_number' type="text" id="modalBondproperty_number" placeholder="رقم العقار"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='area_in_meters' type="text" id="modalBondarea_in_meters" placeholder="المساحة بالمتر"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='area_in_olok' type="text" id="modalBondarea_in_olok" placeholder="المساحة بالأولك"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='area_in_donum' type="text" id="modalBondarea_in_donum" placeholder="المساحة بالدونم"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='count' type="text" id="modalBondcount" placeholder="العدد"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='date' type="date" id="modalBonddate" placeholder="التاريخ"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='volume_number' type="text" id="modalBondvolume_number" placeholder="رقم الجلد"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='ownership' type="text" id="modalBondownership" placeholder="العائدية"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='property_type' type="text" id="modalBondproperty_type" placeholder="جنس العقار"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='governorate' type="text" id="modalBondgovernorate" placeholder="المحافظة"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='district' type="text" id="modalBonddistrict" placeholder="القضاء"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='area' type="text" id="modalBondarea" placeholder="الناحية"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='mortgage_notes' type="text" id="modalBondmortgage_notes" placeholder="إشارات التأمينات"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='registered_office' type="text" id="modalBondregistered_office" placeholder="الدائرة المسجل لديها"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='specialized_department' type="text" id="modalBondspecialized_department" placeholder="الشعبة المختصة"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='property_deed_image' type="text" id="modalBondproperty_deed_image" placeholder="صورة السند العقاري"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='notes' type="text" id="modalBondnotes" placeholder="ملاحظات"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='visibility' type="text" id="modalBondvisibility" placeholder="إمكانية ظهوره"
