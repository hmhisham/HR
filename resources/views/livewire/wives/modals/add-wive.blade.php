                    ...
                    <div class="row row-cols-1  ">
                        <div class="col mb-3">
                            <div class="row">
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model='first_name' type="text" id="modalWivefirst_name" placeholder="الاسم الأول" class="form-control @error('first_name') is-invalid is-filled @enderror" />
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model='father_name' type="text" id="modalWivefather_name" placeholder="اسم الأب" class="form-control @error('father_name') is-invalid is-filled @enderror" />
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model='grandfather_name' type="text" id="modalWivegrandfather_name" placeholder="اسم الجد" class="form-control @error('grandfather_name') is-invalid is-filled @enderror" />
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model='great_grandfather_name' type="text" id="modalWivegreat_grandfather_name" placeholder="اسم والد الجد" class="form-control @error('great_grandfather_name') is-invalid is-filled @enderror" />
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model='surname' type="text" id="modalWivesurname" placeholder="اللقب" class="form-control @error('surname') is-invalid is-filled @enderror" />
                            ...
                            <div Class="row">
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='full_name' type="text" id="modalWivefull_name" placeholder="الاسم الكامل" class="form-control @error('full_name') is-invalid is-filled @enderror" disabled />
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <select wire:model.defer='marital_status' id="modalWivemarital_status" class="form-select @error('marital_status') is-invalid is-filled @enderror">
                            ...
                            <div Class="row">
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='national_id' type="text" id="modalWivenational_id" placeholder="رقم البطاقة الوطنية" class="form-control @error('national_id') is-invalid is-filled @enderror" />
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <div class="form-check">
                                            <input wire:model.defer='is_married' type="checkbox" id="modalWiveis_married" placeholder="الحالة الزوجية" class="form-check-input @error('is_married') is-invalid is-filled @enderror" />
