    ...
    <div class="mb-4 col-12">
        <div class="mt-2 bs-stepper wizard-vertical vertical wizard-numbered wizard-modern">
            <div class="bs-stepper-header gap-lg-2">
                ...
                <div class="step {{ 9 == $currentStep ? $activatedStep : '' }} {{ 9 < $currentStep ? $crossedStep : '' }}"
                    data-target="#step-09">
                    <button {{-- wire:click="buttonStep({{ $stepStep }})" --}} type="button" class="step-trigger">
                        <span class="bs-stepper-circle"><i class="mdi mdi-check"></i></span>
                        <span class="bs-stepper-label">
                            <span class="bs-stepper-number">09</span>
                            <span class="gap-1 d-flex flex-column ms-2">
                                <span class="{{-- bs-stepper-title --}}">صفحة </span>
                                {{-- <span class="bs-stepper-subtitle">Question eLigibility test</span> --}}
                            </span>
                ...
                <div class="step {{ 10 == $currentStep ? $activatedStep : '' }} {{ 10 < $currentStep ? $crossedStep : '' }}"
                    data-target="#step-010">
                    <button {{-- wire:click="buttonStep({{ $stepStep }})" --}} type="button" class="step-trigger">
                        <span class="bs-stepper-circle"><i class="mdi mdi-check"></i></span>
                        <span class="bs-stepper-label">
                            <span class="bs-stepper-number">010</span>
                            <span class="gap-1 d-flex flex-column ms-2">
                                <span class="{{-- bs-stepper-title --}}">صفحة </span>
                                {{-- <span class="bs-stepper-subtitle">Question eLigibility test</span> --}}
                            </span>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='department' type="text"
                                                ...
                                                class="form-control @error('department') is-invalid is-filled @enderror" readonly />
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='division' type="text" id="modalEmployeedivision"
                                                placeholder="الشعبة"
                                                class="form-control @error('division') is-invalid is-filled @enderror" readonly />
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_status' type="text"
                                                ...
                                                class="form-control @error('service_status') is-invalid is-filled @enderror" readonly />
