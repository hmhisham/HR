                                ...
                                <div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='Nopc' type="text"
                                                id="modalEmployeeNopc" placeholder="رقم الحاسبة"
                                                class="form-control @error('Nopc') is-invalid is-filled @enderror" />
                                            <label for="modalEmployeeNopc">رقم الحاسبة</label>
                                        </div>
                                        @error('Nopc')
