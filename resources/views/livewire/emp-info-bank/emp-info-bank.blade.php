        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
<<<<<<< HEAD:resources/views/livewire/employees/employee.blade.php
                        {{-- @can('employee-create')
...
=======
                        @can('employee-create')
                            <a href="{{ Route('AddEmployee') }}" class="mb-3 add-new btn btn-primary mb-md-0">أضــافــة</a>
                        @endcan
>>>>>>> 9440ca23328abeb83a29a0bacb38deb5cecd9f39:resources/views/livewire/emp-info-bank/emp-info-bank.blade.php
                    </div>
                </div>
            </div>
            @can('employee-list')
