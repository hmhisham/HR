                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model='full_name' type="text" id="modalPropertfull_name" readonly
                            ...
                            <div class="col mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model='computer_number' type="text" id="modalPropertcomputer_number"
                                        readonly placeholder="رقم الحاسبة"
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-floating form-floating-outline">
                                    <input wire:model='department_name' type="text" id="modalPropertdepartment_name"
                                        readonly placeholder="القسم"
