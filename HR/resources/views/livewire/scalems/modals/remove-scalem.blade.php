        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='scalems_salary_grade' type="text" id="modalScalemscalems_salary_grade" placeholder="درجة الراتب"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='scalems_salary_stage' type="text" id="modalScalemscalems_salary_stage" placeholder="مرحلة الراتب"
                ...
                <div class="mb-3 col">
                <div class="form-floating form-floating-outline">
                    <input wire:model.defer='scalems_salary' type="text" id="modalScalemscalems_salary" placeholder="الراتب"
