                ...
                <div class="step <?php echo e(2 == $currentStep ? $activatedStep : ''); ?> <?php echo e(2 < $currentStep ? $crossedStep : ''); ?>"
                    ...
                    <button  type="button" class="step-trigger">
                        ...
                        <span class="bs-stepper-label">
                            ...
                            <span class="gap-1 d-flex flex-column ms-2">
                                <span class="">المعلومات الشخصية </span>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='father_name' type="text"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='mother_name' type="text"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='maternal_great_grandfather_name' type="text"
                                                id="modalEmployeematernal_great_grandfather_name"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeematernal_great_grandfather_name">اسم جد
                                                الام</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='phone_number' type="text"
                                                id="modalEmployeephone_number" placeholder="رقم الهاتف"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='email' type="email" id="modalEmployeeemail"
                                                placeholder="Email"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="step-02" class="content <?php echo e(2 == $currentStep ? $activatedStep : ''); ?>">
                        <h4 class="mb-3 fw-bolder">المعلومات الشخصية </h4>
                        <hr>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <label for="governorate_id">محافظة التولد</label>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- قائمة الأقضية التي ستظهر بناءً على المحافظة المختارة -->
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeelocality">العنوان الحالي</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='birth_date' type="date"
                                                id="modalEmployeebirth_date" placeholder="تاريخ التولد"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='birth_place' type="text"
                                                id="modalEmployeebirth_place" placeholder="محل الولادة"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='children_count' type="text"
                                                id="modalEmployeechildren_count" placeholder="عدد الاطفال"
                                                class="form-control <?php $__errorArgs = ['children_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='blood_type' type="text"
                                                id="modalEmployeeblood_type" placeholder="صنف الدم"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='sub_district' type="text"
                                                id="modalEmployeesub_district" placeholder="الناحية"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <select wire:model.defer='locality' id="modalEmployeelocality"
                                                placeholder="محل الولادة"
                                                class="form-select <?php $__errorArgs = ['locality'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <label for="modalEmployeelocality">محل الولادة</label>
                                        </div>
                                        <?php $__errorArgs = ['locality'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col ">
                                        <div class="form-floating form-floating-outline">
                                            <select wire:model.defer='governorate' wire:change='GetDistricts($event.target.value)' id="governorate"
                                                class="form-select <?php $__errorArgs = ['governorate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <label for="governorate">محافظة التولد</label>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='marital_status' type="text"
                                                id="modalEmployeemarital_status" placeholder="الحالة الزوجية"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='id_card_number' type="text"
                                                id="modalEmployeeid_card_number" placeholder="رقم البطاقة"
                                                class="form-control <?php $__errorArgs = ['id_card_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='issue_date' type="date"
                                                id="modalEmployeeissue_date" placeholder="تاريخ الاصدار"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='form_number' type="text"
                                                id="modalEmployeeform_number" placeholder="رقم الاستمارة"
                                                class="form-control <?php $__errorArgs = ['form_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='center_name' type="text"
                                                id="modalEmployeecenter_name" placeholder="اسم المركز"
                                                class="form-control <?php $__errorArgs = ['center_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='center_number' type="text"
                                                id="modalEmployeecenter_number" placeholder="رقم المركز"
                                                class="form-control <?php $__errorArgs = ['center_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='driving_license' type="text"
                                                id="modalEmployeedriving_license" placeholder="اجازة السوق"
                                                class="form-control <?php $__errorArgs = ['driving_license'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='license_expiry_date' type="date"
                                                id="modalEmployeelicense_expiry_date" placeholder="تاريخ الانتهاء"
                                                class="form-control <?php $__errorArgs = ['license_expiry_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['license_expiry_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='education_service' type="text"
                                                id="modalEmployeeeducation_service"
                                                placeholder="التحصيل الدراسي اثناء الخدمة"
                                                class="form-control <?php $__errorArgs = ['education_service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeeeducation_service">التحصيل الدراسي اثناء
                                                الخدمة</label>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='graduation_year_service' type="text"
                                                id="modalEmployeegraduation_year_service"
                                                placeholder="سنة التخرج اثناء الخدمة"
                                                class="form-control <?php $__errorArgs = ['graduation_year_service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeegraduation_year_service">سنة التخرج اثناء
                                                الخدمة</label>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='graduation_institution_service' type="text"
                                                id="modalEmployeegraduation_institution_service"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeegraduation_institution_service">جهة التخرج اثناء
                                                الخدمة</label>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='specialization_service' type="text"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeespecialization_service">الاختصاص اثناء
                                                الخدمة</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='document_date' type="date"
                                                id="modalEmployeedocument_date" placeholder="تاريخ الوثيقة"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='document_verification_number' type="text"
                                                id="modalEmployeedocument_verification_number"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeedocument_verification_number">رقم صحة
                                                الصدور</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='document_verification_date' type="date"
                                                id="modalEmployeedocument_verification_date"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeedocument_verification_date">تاريخ صحة
                                                الصدور</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='education_appointment' type="text"
                                                id="modalEmployeeeducation_appointment"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeeeducation_appointment">التحصيل الدراسي
                                                التعيين</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='graduation_year_appointment' type="text"
                                                id="modalEmployeegraduation_year_appointment"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeegraduation_year_appointment">سنة تخرج
                                                التعيين</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='specialization_appointment' type="text"
                                                id="modalEmployeespecialization_appointment"
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeespecialization_appointment">الاختصاص
                                                التعيين</label>
                                        </div>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_type' type="text"
                                                id="modalEmployeeservice_type" placeholder="نوع الخدمة"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_status' type="text"
                                                id="modalEmployeeservice_status" placeholder="حالة الخدمة"
                                                class="form-control <?php $__errorArgs = ['service_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='contract_type' type="text"
                                                id="modalEmployeecontract_type" placeholder="نوع العقد"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_case_type' type="text"
                                                id="modalEmployeeservice_case_type" placeholder="نوع حالة الخدمة"
                                                class="form-control <?php $__errorArgs = ['service_case_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['service_case_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='general_specialization' type="text"
                                                id="modalEmployeegeneral_specialization" placeholder="التخصص العام"
                                                class="form-control <?php $__errorArgs = ['general_specialization'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['general_specialization'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='precise_specialization' type="text"
                                                id="modalEmployeeprecise_specialization" placeholder="التخصص الدقيق"
                                                class="form-control <?php $__errorArgs = ['precise_specialization'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['precise_specialization'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='degree' type="text" id="modalEmployeedegree"
                                                placeholder="د / و"
                                                class="form-control <?php $__errorArgs = ['degree'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='position_title' type="text"
                                                id="modalEmployeeposition_title" placeholder="العنوان الوظيفي"
                                                class="form-control <?php $__errorArgs = ['position_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['position_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='appointment_order_number' type="text"
                                                ...
                                                class="form-control <?php $__errorArgs = ['appointment_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['appointment_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='appointment_date' type="date"
                                                id="modalEmployeeappointment_date" placeholder="تاريخ التعيين"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='start_work_date' type="date"
                                                id="modalEmployeestart_work_date" placeholder="تاريخ المباشرة"
                                                class="form-control <?php $__errorArgs = ['start_work_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='promotion_order' type="text"
                                                id="modalEmployeepromotion_order" placeholder="امر الترفيع"
                                                class="form-control <?php $__errorArgs = ['promotion_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['promotion_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='promotion_date' type="date"
                                                id="modalEmployeepromotion_date" placeholder="تاريخ الترفيع"
                                                class="form-control <?php $__errorArgs = ['promotion_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='entitlement_date' type="date"
                                                id="modalEmployeeentitlement_date" placeholder="تاريخ الاستحقاق"
                                                class="form-control <?php $__errorArgs = ['entitlement_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['entitlement_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='increment_order' type="text"
                                                id="modalEmployeeincrement_order" placeholder="امر العلاوة"
                                                class="form-control <?php $__errorArgs = ['increment_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['increment_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='increment_date' type="date"
                                                id="modalEmployeeincrement_date" placeholder="تاريخ العلاوة"
                                                class="form-control <?php $__errorArgs = ['increment_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['increment_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='referral_order_number' type="text"
                                                id="modalEmployeereferral_order_number" placeholder="رقم امر الاحالة"
                                                class="form-control <?php $__errorArgs = ['referral_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['referral_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='referral_order_date' type="date"
                                                id="modalEmployeereferral_order_date" placeholder="تاريخ رقم الاحالة"
                                                class="form-control <?php $__errorArgs = ['referral_order_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['referral_order_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='termination_reason' type="text"
                                                id="modalEmployeetermination_reason" placeholder="انهاء التعيين"
                                                class="form-control <?php $__errorArgs = ['termination_reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['termination_reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='transfer_date' type="date"
                                                id="modalEmployeetransfer_date" placeholder="تاريخ النقل الينا"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='resumption_date' type="text"
                                                id="modalEmployeeresumption_date" placeholder="المباشرة"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='binding_authority' type="text"
                                                id="modalEmployeebinding_authority" placeholder="الارتباط"
                                                class="form-control <?php $__errorArgs = ['binding_authority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['binding_authority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='department' type="text"
                                                id="modalEmployeedepartment" placeholder="القسم"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='secondment_authority' type="text"
                                                id="modalEmployeesecondment_authority" placeholder="جهة التنسيب"
                                                class="form-control <?php $__errorArgs = ['secondment_authority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['secondment_authority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='position_start_date' type="text"
                                                id="modalEmployeeposition_start_date" placeholder="مباشرة المنصب"
                                                class="form-control <?php $__errorArgs = ['position_start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['position_start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='issuing_authority' type="text"
                                                id="modalEmployeeissuing_authority" placeholder="جهة اصدار الامر"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_order_number' type="text"
                                                id="modalEmployeeassignment_order_number" placeholder="رقم امر التكليف"
                                                class="form-control <?php $__errorArgs = ['assignment_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['assignment_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_order_date' type="date"
                                                id="modalEmployeeassignment_order_date" placeholder="تاريخ امر التكليف"
                                                class="form-control <?php $__errorArgs = ['assignment_order_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['assignment_order_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_type' type="text"
                                                id="modalEmployeeassignment_type" placeholder="نوع التكليف"
                                                class="form-control <?php $__errorArgs = ['assignment_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='assignment_status' type="text"
                                                id="modalEmployeeassignment_status" placeholder="حالة التكليف"
                                                class="form-control <?php $__errorArgs = ['assignment_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['assignment_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_position' type="text"
                                                id="modalEmployeesecond_position" placeholder="المنصب 2"
                                                class="form-control <?php $__errorArgs = ['second_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['second_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_position_start_date' type="text"
                                                id="modalEmployeesecond_position_start_date"
                                                placeholder="مباشرة المنصب 2"
                                                class="form-control <?php $__errorArgs = ['second_position_start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['second_position_start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_issuing_authority' type="text"
                                                id="modalEmployeesecond_issuing_authority"
                                                placeholder="جهة اصدار الامر 2"
                                                class="form-control <?php $__errorArgs = ['second_issuing_authority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['second_issuing_authority'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_assignment_order_number' type="text"
                                                id="modalEmployeesecond_assignment_order_number"
                                                placeholder="رقم امر التكليف 2"
                                                class="form-control <?php $__errorArgs = ['second_assignment_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeesecond_assignment_order_number">رقم امر التكليف
                                                2</label>
                                        </div>
                                        <?php $__errorArgs = ['second_assignment_order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_assignment_order_date' type="date"
                                                id="modalEmployeesecond_assignment_order_date"
                                                placeholder="تاريخ امر التكليف 2"
                                                class="form-control <?php $__errorArgs = ['second_assignment_order_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                            <label for="modalEmployeesecond_assignment_order_date">تاريخ امر التكليف
                                                2</label>
                                        </div>
                                        <?php $__errorArgs = ['second_assignment_order_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_assignment_type' type="text"
                                                id="modalEmployeesecond_assignment_type" placeholder="نوع التكليف2"
                                                class="form-control <?php $__errorArgs = ['second_assignment_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['second_assignment_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='second_assignment_status' type="text"
                                                id="modalEmployeesecond_assignment_status" placeholder="حالة التكليف2"
                                                class="form-control <?php $__errorArgs = ['second_assignment_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['second_assignment_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='end_date' type="date" id="modalEmployeeend_date"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_days' type="text"
                                                id="modalEmployeeservice_days" placeholder="الخدمة يوم"
                                                class="form-control <?php $__errorArgs = ['service_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_months' type="text"
                                                id="modalEmployeeservice_months" placeholder="الخدمة شهر"
                                                class="form-control <?php $__errorArgs = ['service_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['service_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='service_years' type="text"
                                                id="modalEmployeeservice_years" placeholder="الخدمة سنة"
                                                class="form-control <?php $__errorArgs = ['service_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_retirement_days' type="text"
                                                id="modalEmployeetotal_retirement_days" placeholder="مجموع التقاعد يوم"
                                                class="form-control <?php $__errorArgs = ['total_retirement_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_retirement_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_retirement_months' type="text"
                                                id="modalEmployeetotal_retirement_months"
                                                placeholder="مجموع التقاعد شهر"
                                                class="form-control <?php $__errorArgs = ['total_retirement_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_retirement_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_retirement_years' type="text"
                                                id="modalEmployeetotal_retirement_years" placeholder="مجموع التقاعد سنة"
                                                class="form-control <?php $__errorArgs = ['total_retirement_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_retirement_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_actual_days' type="text"
                                                id="modalEmployeetotal_actual_days" placeholder="مجموع الفعلية يوم"
                                                class="form-control <?php $__errorArgs = ['total_actual_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_actual_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_actual_months' type="text"
                                                id="modalEmployeetotal_actual_months" placeholder="مجموع الفعلية شهر"
                                                class="form-control <?php $__errorArgs = ['total_actual_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_actual_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_actual_years' type="text"
                                                id="modalEmployeetotal_actual_years" placeholder="مجموع الفعلية سنة"
                                                class="form-control <?php $__errorArgs = ['total_actual_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_actual_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_college_days' type="text"
                                                id="modalEmployeetotal_college_days" placeholder="مجموع الكلية يوم"
                                                class="form-control <?php $__errorArgs = ['total_college_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_college_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_college_months' type="text"
                                                id="modalEmployeetotal_college_months" placeholder="مجموع الكلية شهر"
                                                class="form-control <?php $__errorArgs = ['total_college_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_college_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='total_college_years' type="text"
                                                id="modalEmployeetotal_college_years" placeholder="مجموع الكلية سنة"
                                                class="form-control <?php $__errorArgs = ['total_college_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />
                                        ...
                                        <?php $__errorArgs = ['total_college_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='mypassword' type="text"
                                                id="modalEmployeemypassword" placeholder="كلمة السر"
                                                class="form-control <?php $__errorArgs = ['mypassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='governorate' type="text"
                                                id="modalEmployeegovernorate" placeholder="المحافظة"
                                                class="form-control <?php $__errorArgs = ['governorate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="step-06" class="content <?php echo e(6 == $currentStep ? $activatedStep : ''); ?>">
                        <h4 class="mb-3 fw-bolder">صفحة 6 </h4>
                        <hr>
