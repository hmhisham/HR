...
<script src="<?php echo e(asset(mix('assets/vendor/js/preloader.js'))); ?>"></script>
...
<!-- END: Page JS-->
<?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/layouts/sections/scriptsFront.blade.php ENDPATH**/ ?>