...
} elseif ($_instance->childHasBeenRendered('tYvFVnb')) {
    $componentId = $_instance->getRenderedChildComponentId('tYvFVnb');
    $componentTag = $_instance->getRenderedChildComponentTagName('tYvFVnb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tYvFVnb');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.roles.account-roles');
    $html = $response->html();
    $_instance->logRenderedChild('tYvFVnb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\HR\resources\views/content/Owner/Permission&Roles/Roles/index.blade.php ENDPATH**/ ?>