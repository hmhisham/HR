...
} elseif ($_instance->childHasBeenRendered('VWGAc7q')) {
    $componentId = $_instance->getRenderedChildComponentId('VWGAc7q');
    $componentTag = $_instance->getRenderedChildComponentTagName('VWGAc7q');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VWGAc7q');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.roles.account-roles');
    $html = $response->html();
    $_instance->logRenderedChild('VWGAc7q', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
