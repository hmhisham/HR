                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $Branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Branc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <?php $i++; ?>
                                <td><?php echo e($i); ?></td>
                                <td class="text-center"><?php echo e($Branc->Getlinkage ? $Branc->Getlinkage->Linkages_name : ''); ?>

                                </td>
                                <td class="text-center"><?php echo e($Branc->Getsection ? $Branc->Getsection->section_name : ''); ?>
                                ...
                                <td Class="text-center">
                                    <div class="btn-group" role="group" aria-label="First group">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('branc-edit')): ?>
                                            <button wire:click="GetBranc(<?php echo e($Branc->id); ?>)"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('branc-delete')): ?>
                                            <button wire:click="GetBranc(<?php echo e($Branc->id); ?>)"
                                                class="p-0 px-1 btn btn-outline-danger waves-effect <?php echo e($Branc->active ? 'disabled' : ''); ?>"
