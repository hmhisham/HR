...
} elseif ($_instance->childHasBeenRendered('PUiD3B4')) {
    $componentId = $_instance->getRenderedChildComponentId('PUiD3B4');
    $componentTag = $_instance->getRenderedChildComponentTagName('PUiD3B4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PUiD3B4');
} else {
    $response = \Livewire\Livewire::mount('users.administrators-accounts.administrators-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('PUiD3B4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
