...
} elseif ($_instance->childHasBeenRendered('sZCj2kQ')) {
    $componentId = $_instance->getRenderedChildComponentId('sZCj2kQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('sZCj2kQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sZCj2kQ');
} else {
    $response = \Livewire\Livewire::mount('users.administrators-accounts.administrators-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('sZCj2kQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel 2024\HR\HR\resources\views/content/Users/AdministratorsAccounts/index.blade.php ENDPATH**/ ?>