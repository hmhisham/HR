...
} elseif ($_instance->childHasBeenRendered('iykecdz')) {
    $componentId = $_instance->getRenderedChildComponentId('iykecdz');
    $componentTag = $_instance->getRenderedChildComponentTagName('iykecdz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iykecdz');
} else {
    $response = \Livewire\Livewire::mount('childrens.children');
    $html = $response->html();
    $_instance->logRenderedChild('iykecdz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel 2024\HR\HR\resources\views/content/Childrens/index.blade.php ENDPATH**/ ?>