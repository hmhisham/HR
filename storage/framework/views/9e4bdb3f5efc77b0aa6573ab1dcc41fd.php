...
} elseif ($_instance->childHasBeenRendered('QNIIfvk')) {
    $componentId = $_instance->getRenderedChildComponentId('QNIIfvk');
    $componentTag = $_instance->getRenderedChildComponentTagName('QNIIfvk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QNIIfvk');
} else {
    $response = \Livewire\Livewire::mount('precises.precise');
    $html = $response->html();
    $_instance->logRenderedChild('QNIIfvk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
