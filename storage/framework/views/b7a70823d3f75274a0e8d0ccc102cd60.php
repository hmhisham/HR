                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee-create')): ?>
                            <a wire:click='AddEmployeeModalShow' class="mb-3 add-new btn btn-primary mb-md-0">أضــافــة</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php /**PATH F:\LaravelProjects\HR\resources\views/livewire/employees/employee.blade.php ENDPATH**/ ?>