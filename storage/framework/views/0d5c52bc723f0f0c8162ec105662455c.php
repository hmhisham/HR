<!-- Remove Jobtitle Modal -->
<div wire:ignore.self class="modal fade" id="removejobtitleModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">حذف الدرجة الوظيفية</h3>
                    <p>نافذة الحذف</p>
                </div>
                <hr class="mt-n2">
                ...
                <div wire:loading.remove>
                    <form id="removeJobtitleModalForm" onsubmit="return false" autocomplete="off">
...
<!--/ Delete Jobtitle Modal -->
<?php /**PATH C:\Users\11\Desktop\HR\resources\views/livewire/jobtitles/modals/remove-jobtitle.blade.php ENDPATH**/ ?>