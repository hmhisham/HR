...
} elseif ($_instance->childHasBeenRendered('Oab3zTi')) {
    $componentId = $_instance->getRenderedChildComponentId('Oab3zTi');
    $componentTag = $_instance->getRenderedChildComponentTagName('Oab3zTi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Oab3zTi');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.permissions.account-permissions');
    $html = $response->html();
    $_instance->logRenderedChild('Oab3zTi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\11\Desktop\HR\resources\views/content/Owner/Permission&Roles/Permissions/index.blade.php ENDPATH**/ ?>