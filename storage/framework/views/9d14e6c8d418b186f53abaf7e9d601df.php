                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='scalems_salary_grade' type="text"
                                                ...
                                                class="form-control <?php $__errorArgs = ['scalems_salary_grade'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
<!--/ Edite Scalem Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/scalems/modals/edit-scalem.blade.php ENDPATH**/ ?>