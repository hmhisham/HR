<!DOCTYPE html>
<html lang="<?php echo e(session()->get('locale') ?? app()->getLocale()); ?>" dir="<?php echo e($configData['textDirection']); ?>"
	class="<?php echo e($configData['style']); ?>-style <?php echo e($navbarFixed ?? ''); ?> <?php echo e($menuFixed ?? ''); ?> <?php echo e($menuCollapsed ?? ''); ?> <?php echo e($menuFlipped ?? ''); ?> <?php echo e($menuOffcanvas ?? ''); ?> <?php echo e($footerFixed ?? ''); ?> <?php echo e($customizerHidden ?? ''); ?>"
	data-theme="<?php echo e($configData['theme']); ?>" data-assets-path="<?php echo e(asset('/assets') . '/'); ?>" data-base-url="<?php echo e(url('/')); ?>" data-framework="laravel"
...
<?php /**PATH F:\LaravelProjects\JAZContentManagement-Copy\resources\views/layouts/commonMaster.blade.php ENDPATH**/ ?>