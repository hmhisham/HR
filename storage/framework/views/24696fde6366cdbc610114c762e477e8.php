...
} elseif ($_instance->childHasBeenRendered('2nvAlgT')) {
    $componentId = $_instance->getRenderedChildComponentId('2nvAlgT');
    $componentTag = $_instance->getRenderedChildComponentTagName('2nvAlgT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2nvAlgT');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.roles.account-roles');
    $html = $response->html();
    $_instance->logRenderedChild('2nvAlgT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
