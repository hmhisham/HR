...
} elseif ($_instance->childHasBeenRendered('JJWalJV')) {
    $componentId = $_instance->getRenderedChildComponentId('JJWalJV');
    $componentTag = $_instance->getRenderedChildComponentTagName('JJWalJV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JJWalJV');
} else {
    $response = \Livewire\Livewire::mount('graduations.graduation');
    $html = $response->html();
    $_instance->logRenderedChild('JJWalJV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
