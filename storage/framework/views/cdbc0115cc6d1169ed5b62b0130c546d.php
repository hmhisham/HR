...
} elseif ($_instance->childHasBeenRendered('nGt86Ry')) {
    $componentId = $_instance->getRenderedChildComponentId('nGt86Ry');
    $componentTag = $_instance->getRenderedChildComponentTagName('nGt86Ry');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nGt86Ry');
} else {
    $response = \Livewire\Livewire::mount('graduations.graduation');
    $html = $response->html();
    $_instance->logRenderedChild('nGt86Ry', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
