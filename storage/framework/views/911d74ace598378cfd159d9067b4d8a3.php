...
} elseif ($_instance->childHasBeenRendered('hrv5SbV')) {
    $componentId = $_instance->getRenderedChildComponentId('hrv5SbV');
    $componentTag = $_instance->getRenderedChildComponentTagName('hrv5SbV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hrv5SbV');
} else {
    $response = \Livewire\Livewire::mount('thanks.thank');
    $html = $response->html();
    $_instance->logRenderedChild('hrv5SbV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
