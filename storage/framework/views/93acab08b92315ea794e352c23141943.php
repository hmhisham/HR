                ...
                <li
                    ...
                    <ul class="menu-sub">
                        ...
                        <li Class="menu-item <?php echo e(request()->Is('Certificates') ? 'active' : ''); ?>">
                         ...
                         <li Class="menu-item <?php echo e(request()->Is('Gyears') ? 'active' : ''); ?>">
                            <a href="<?php echo e(Route('Gyears.index')); ?>" Class="menu-link">
                                <i Class=''></i>
...
<?php echo $__env->make('layouts/commonMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\11\Desktop\HR\resources\views/layouts/contentNavbarLayout.blade.php ENDPATH**/ ?>