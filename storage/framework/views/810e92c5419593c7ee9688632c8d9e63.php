...
} elseif ($_instance->childHasBeenRendered('dXyysoJ')) {
    $componentId = $_instance->getRenderedChildComponentId('dXyysoJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('dXyysoJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dXyysoJ');
} else {
    $response = \Livewire\Livewire::mount('penalties.penaltie');
    $html = $response->html();
    $_instance->logRenderedChild('dXyysoJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\HR\resources\views/content/Penalties/index.blade.php ENDPATH**/ ?>