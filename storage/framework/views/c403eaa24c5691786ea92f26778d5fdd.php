                        ...
                        <div class="row">
                            <div class="col text-center">
                                <div class="">
                                    ...
                                    <div class="form-control-plaintext mt-n2"><?php echo e($linkageName); ?></div>
                                </div>
                            </div>
                            <div class="col text-center">
                                <div class="">
                                    <label for="modalUnitunits_name">القسم</label>
                                    <div class="form-control-plaintext mt-n2"><?php echo e($SectionsName); ?></div>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col text-center">
                                <div class="text-danger">
                                    ...
                                    <div class="form-control-plaintext mt-n2"><?php echo e($branch_name); ?></div>
                                </div>
                            </div>
                        </div>
...
<!--/ Delete Branc Modal -->
<?php /**PATH C:\Users\11\Desktop\HR\resources\views/livewire/branch/modals/remove-branc.blade.php ENDPATH**/ ?>