...
} elseif ($_instance->childHasBeenRendered('FRRFHIx')) {
    $componentId = $_instance->getRenderedChildComponentId('FRRFHIx');
    $componentTag = $_instance->getRenderedChildComponentTagName('FRRFHIx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FRRFHIx');
} else {
    $response = \Livewire\Livewire::mount('wives.wive');
    $html = $response->html();
    $_instance->logRenderedChild('FRRFHIx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
