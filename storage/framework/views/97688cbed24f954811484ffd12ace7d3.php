...
} elseif ($_instance->childHasBeenRendered('Cbi01XK')) {
    $componentId = $_instance->getRenderedChildComponentId('Cbi01XK');
    $componentTag = $_instance->getRenderedChildComponentTagName('Cbi01XK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Cbi01XK');
} else {
    $response = \Livewire\Livewire::mount('thanks.thank');
    $html = $response->html();
    $_instance->logRenderedChild('Cbi01XK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\HR\resources\views/content/Thanks/index.blade.php ENDPATH**/ ?>