...
<?php $__env->startSection('content'); ?>
    <div class="row gy-4">
            ...
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="order-2 col-md-6 order-md-1">
                        <div class="card-body">
                            <h4 class="card-title pb-xl-2">لوحة متابعة الادارة</h4>
                            <p class="mb-0">You have done <span class="fw-semibold">68%</span>😎 more sales today.</p>
                            <p>Check your new badge in your profile.</p>
                            <a href="javascript:;" class="btn btn-primary">View Profile</a>
                        </div>
                    </div>
                    <div class="order-1 text-center col-md-6 text-md-end order-md-2">
                        <div class="px-0 pb-0 card-body px-md-4 ps-0">
                            <img src="<?php echo e(asset('assets/img/illustrations/illustration-john-'.$configData['style'].'.png')); ?>"
        ...
        <div class="col-lg-2 col-sm-6">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="pt-1 mt-4 card-info mt-lg-1 mt-xl-4">
        ...
        <div class="col-lg-2 col-sm-6">
            <div class="card h-100">
                <div class="pb-0 card-header">
                    <div class="flex-wrap gap-2 mb-1 d-flex align-items-end">
                        <h4 class="mb-0 me-2">$38.5k</h4>
                        <p class="mb-0 text-success">+62%</p>
                    </div>
                    <span class="mb-2 d-block text-muted">Sessions</span>
                </div>
                <div class="card-body">
                    <div id="sessions"></div>
                </div>
        ...
        <div class="col-12 col-xl-8">
            <div class="card">
                <div class="row">
                    <div class="order-2 col-md-7 col-12 order-md-0">
                    ...
                    <div class="col-md-5 col-12 border-start">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="dropdown">
                                    <button class="p-0 btn" type="button" id="totalTransaction" data-bs-toggle="dropdown"
                            ...
                            <p class="mb-0 text-muted">Last month transactions $234.40k</p>
                        </div>
                        <div class="pt-3 card-body">
                            <div class="row">
                                <div class="col-6 border-end">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <p class="my-2 text-muted">This Week</p>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    <p class="mb-1 text-muted">Performance</p>
            ...
            <div class="card">
                <div class="pb-1 card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="p-0 btn" type="button" id="performanceDropdown" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="m-0 card-title me-2">Project Statistics</h5>
                    <div class="dropdown">
                ...
                <div class="card-body">
                    <ul class="p-0 m-0">
                        ...
                        <li class="mb-4 d-flex">
                            <div class="flex-shrink-0 avatar avatar-md me-3">
                                <div class="rounded avatar-initial bg-lighter">
                                    <div>
                                        <img src="<?php echo e(asset('assets/img/icons/misc/3d-illustration.png')); ?>" alt="User"
                                            class="h-25">
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="mb-4 d-flex">
                            <div class="flex-shrink-0 avatar avatar-md me-3">
                                <div class="rounded avatar-initial bg-lighter">
                                    <div>
                                        <img src="<?php echo e(asset('assets/img/icons/misc/finance-app-design.png')); ?>" alt="User"
                                            class="h-25">
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="mb-4 d-flex">
                            <div class="flex-shrink-0 avatar avatar-md me-3">
                                <div class="rounded avatar-initial bg-lighter">
                                    <div>
                                        <img src="<?php echo e(asset('assets/img/icons/misc/4-square.png')); ?>" alt="User" class="h-25">
                                    </div>
                                </div>
                            </div>
                            <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                        ...
                        <li class="mb-4 d-flex">
                            <div class="flex-shrink-0 avatar avatar-md me-3">
                                <div class="rounded avatar-initial bg-lighter">
                                    <div>
                                        <img src="<?php echo e(asset('assets/img/icons/misc/delta-web-app.png')); ?>" alt="User"
                                            class="h-25">
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="d-flex">
                            <div class="flex-shrink-0 avatar avatar-md me-3">
                                <div class="rounded avatar-initial bg-lighter">
                                    <div>
                                        <img src="<?php echo e(asset('assets/img/icons/misc/ecommerce-website.png')); ?>" alt="User"
                                            class="h-25">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="card">
                        <div class="pb-0 card-header">
                            ...
                            <span class="mb-2 d-block text-muted">Total Revenue</span>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pt-3 mt-4 card-info">
                                <h5 class="mb-2">$13.4k</h5>
                                <p class="text-muted">Total Sales</p>
                                <div class="mt-1 badge bg-label-secondary rounded-pill">Last Sales </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="card">
                        <div class="pb-0 card-header">
                            ...
                            <span class="mb-2 d-block text-muted">Overview</span>
                        </div>
                        <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="p-0 btn" type="button" id="salesCountryDropdown" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
        ...
        <div class="col-12 col-xl-8">
            <div class="card">
                ...
                <div class="pb-3 card-body">
                    <ul class="gap-4 pb-3 mx-1 nav nav-tabs nav-tabs-widget d-flex flex-nowrap" role="tablist">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <div class="nav-link btn d-flex align-items-center justify-content-center disabled" role="tab"
                                data-bs-toggle="tab" aria-selected="false">
                                <button type="button" class="rounded btn btn-icon bg-label-secondary">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="pe-0"><span class="badge rounded-pill bg-label-primary">Active</span>
                                            </td>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pe-0"><span class="badge rounded-pill bg-label-danger">Expired</span>
                                            </td>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="p-0 btn" type="button" id="weeklySalesDropdown" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
                    ...
                    <p class="mb-0 text-muted">Total 85.4k Sales</p>
                </div>
                <div class="card-body">
                    <div class="mb-2 row">
                        <div class="col-6 d-flex align-items-center">
                            ...
                            <div class="ms-3 d-flex flex-column">
                                <small class="mb-1 text-muted">Net Income</small>
                        ...
                        <div class="col-6 d-flex align-items-center">
                            ...
                            <div class="ms-3 d-flex flex-column">
                                <small class="mb-1 text-muted">Expense</small>
            ...
            <div class="card">
                <div class="pb-1 card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="p-0 btn" type="button" id="visitsByDayDropdown" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="p-0 btn" type="button" id="timelineDropdown" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
                ...
                <div class="pt-4 pb-1 card-body">
                    <ul class="mb-0 timeline card-timeline">
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                ...
                                <p class="mb-2 text-muted">Product introduction and details video</p>
                                <div class="d-flex">
                                    <a href="https://www.youtube.com/@pixinvent1515" target="_blank" class="text-truncate">
                                        <span class="badge badge-center rounded-pill bg-danger w-px-20 h-px-20 me-2">
                                            <i class="text-white mdi mdi-play"></i>
                                        </span>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                ...
                                <p class="mb-2 text-muted">Received payment $1,490 for banking ios app</p>
                            </div>
                        </li>
                        <li class="border-0 timeline-item timeline-item-transparent">
                            <span class="timeline-point timeline-point-warning"></span>
                            <div class="pb-1 timeline-event">
                                <div class="mb-1 timeline-header">
                                    <h6 class="mb-2 fw-semibold">Meeting with joseph morgan for next project</h6>
                                    <small class="text-muted">April, 23</small>
                                </div>
                                <p class="mb-2 text-muted">Meeting Video call on zoom at 9pm</p>
                                <div class="d-flex">
                                    <a href="javascript:void(0)" class="me-3">
                                        <img src="<?php echo e(asset('assets/img/icons/misc/pdf.png')); ?>" alt="PDF image" width="20"
                                            class="me-2">
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement-Copy\resources\views/content/Owner/Dashboard/Dashboard.blade.php ENDPATH**/ ?>