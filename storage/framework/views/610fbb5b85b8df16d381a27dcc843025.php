                    ...
                    <div class="row row-cols-1  ">
                        ...
                        <div Class="row">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='specialtys_code' type="text" id="modalSpecialtysspecialtys_code" placeholder="الرمز"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='specialtys_name' type="text" id="modalSpecialtysspecialtys_name" placeholder="اسم التخصص"
...
<!--/ Add Specialty Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/specialtys/modals/add-specialty.blade.php ENDPATH**/ ?>