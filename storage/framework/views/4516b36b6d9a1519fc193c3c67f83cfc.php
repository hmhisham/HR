...
} elseif ($_instance->childHasBeenRendered('5qqyMci')) {
    $componentId = $_instance->getRenderedChildComponentId('5qqyMci');
    $componentTag = $_instance->getRenderedChildComponentTagName('5qqyMci');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5qqyMci');
} else {
    $response = \Livewire\Livewire::mount('areas.area');
    $html = $response->html();
    $_instance->logRenderedChild('5qqyMci', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
