        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">حذف جهة التخرج</h3>
                    <p>نافذة الحذف</p>
                </div>
                <hr class="mt-n2">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='graduations_name' type="text"
                                                id="modalGraduationgraduations_name" placeholder="جهة التخرج"
...
<?php /**PATH C:\Users\11\Desktop\HR\resources\views/livewire/graduations/modals/remove-graduation.blade.php ENDPATH**/ ?>