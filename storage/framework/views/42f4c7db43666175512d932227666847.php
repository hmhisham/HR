...
<!-- Add Link Modal -->
<div wire:ignore.self class="modal fade" id="addlinkModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <form id="addlinkModalForm" autocomplete="off">
...
<!--/ Add Link Modal -->
<?php /**PATH D:\laravel\HR\resources\views/livewire/links/modals/add-link.blade.php ENDPATH**/ ?>