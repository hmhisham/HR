<!-- Add Departmen Modal -->
<div wire:ignore.self class="modal fade" id="adddepartmenModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <form id="adddepartmenModalForm" autocomplete="off">
...
<!--/ Add Departmen Modal -->
<?php /**PATH C:\Users\11\Desktop\HR\resources\views/livewire/department/modals/add-departmen.blade.php ENDPATH**/ ?>