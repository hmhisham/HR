...
} elseif ($_instance->childHasBeenRendered('kY7FkEe')) {
    $componentId = $_instance->getRenderedChildComponentId('kY7FkEe');
    $componentTag = $_instance->getRenderedChildComponentTagName('kY7FkEe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kY7FkEe');
} else {
    $response = \Livewire\Livewire::mount('users.customers-accounts.customers-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('kY7FkEe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/content/Users/CustomersAccounts/index.blade.php ENDPATH**/ ?>