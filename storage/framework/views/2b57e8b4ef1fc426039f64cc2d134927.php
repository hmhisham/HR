    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <h5 wire:loading wire:target="GetJobleaver" wire:loading.class="d-flex justify-content-center text-primary">جار معالجة البيانات...</h5>
                    ...
                    <div class="row row-cols-1">
                        ...
                        '<Div Class="row">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='calculator_number' type="text" id="modalJobleavercalculator_number" placeholder="رقم الحاسبة"
...
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/jobleavers/modals/remove-jobleaver.blade.php ENDPATH**/ ?>