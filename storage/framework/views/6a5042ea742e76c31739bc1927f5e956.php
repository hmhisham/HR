<!-- Add Grade Modal -->
<div wire:ignore.self class="modal fade" id="addgradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <form id="addgradeModalForm" autocomplete="off">
...
<!--/ Add Grade Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/grades/modals/add-grade.blade.php ENDPATH**/ ?>