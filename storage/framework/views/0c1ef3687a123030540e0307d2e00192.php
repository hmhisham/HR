                ...
                <form id="editCertifiModalForm" autocomplete="off">
                    <div class="row row-cols-1">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='user_id' type="text" id="modalCertifiuser_id" placeholder="رقم المستخدم"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='calculator_number' type="text" id="modalCertificalculator_number" placeholder="رقم الحاسبة"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='document_number' type="text" id="modalCertifidocument_number" placeholder="رقم الوثيقة"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='certificate_name' type="text" id="modalCertificertificate_name" placeholder="الشهادة"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='authenticity_number' type="text" id="modalCertifiauthenticity_number" placeholder="رقم صحة الصدور"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='authenticity_date' type="date" id="modalCertifiauthenticity_date" placeholder="تاريخ صحة الصدور"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='educational_attainment' type="text" id="modalCertifieducational_attainment" placeholder="تحصيل الدراسي"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='college_name' type="text" id="modalCertificollege_name" placeholder="اسم الكلية"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='department_name' type="text" id="modalCertifidepartment_name" placeholder="القسم الدراسي"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='specialization' type="text" id="modalCertifispecialization" placeholder="التخصص"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='graduation_year' type="text" id="modalCertifigraduation_year" placeholder="سنة التخرج"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='grade' type="text" id="modalCertifigrade" placeholder="التقدير والدرجة"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='issuing_country' type="text" id="modalCertifiissuing_country" placeholder="البلد المانح للشهادة"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col">
                        <div class="form-floating form-floating-outline">
                            <input wire:model.defer='status' type="text" id="modalCertifistatus" placeholder="الحالة"
...
<!--/ Edite Certifi Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/certific/modals/edit-certifi.blade.php ENDPATH**/ ?>