    ...
    <div class="authentication-wrapper authentication-cover">
        ...
        <div class="m-0 authentication-inner row">
            ...
            <div class="p-3 pb-2 d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center">
                ...
                <img src="<?php echo e(asset('assets/img/illustrations/auth-cover-login-mask-'.$configData['style'].'.png')); ?>"
...
<?php echo $__env->make('layouts/blankLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/auth/login.blade.php ENDPATH**/ ?>