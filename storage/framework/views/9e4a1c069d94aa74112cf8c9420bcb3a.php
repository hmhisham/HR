...
} elseif ($_instance->childHasBeenRendered('WIaMa2i')) {
    $componentId = $_instance->getRenderedChildComponentId('WIaMa2i');
    $componentTag = $_instance->getRenderedChildComponentTagName('WIaMa2i');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WIaMa2i');
} else {
    $response = \Livewire\Livewire::mount('users.customers-accounts.customers-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('WIaMa2i', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement-Copy\resources\views/content/Users/CustomersAccounts/index.blade.php ENDPATH**/ ?>