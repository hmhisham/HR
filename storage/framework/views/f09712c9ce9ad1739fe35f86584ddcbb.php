            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button wire:click='AddSectionModalShow' class="mb-3 add-new btn btn-primary mb-md-0" data-bs-toggle="modal" data-bs-target="#addsectionModal">أضــافــة</button>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo e($Section->Getlinkage ? $Section->Getlinkage->Linkages_name : ''); ?></td>
                        ...
                        <td Class="text-center">
                            <div class="btn-group" role="group" aria-label="First group">
                                ...
                                <button wire:click="GetSection(<?php echo e($Section->id); ?>)" class="p-0 px-1 btn btn-outline-success waves-effect" data-bs-toggle="modal" data-bs-target="#editsectionModal">
                                    <i class="tf-icons mdi mdi-pencil fs-3"></i>
                                </button>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('section-delete')): ?>
                                <button wire:click="GetSection(<?php echo e($Section->id); ?>)" class="p-0 px-1 btn btn-outline-danger waves-effect <?php echo e($Section->active ? 'disabled' : ''); ?>" data-bs-toggle="modal" data-bs-target="#removesectionModal">
...
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/sections/section.blade.php ENDPATH**/ ?>