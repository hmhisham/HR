                            ...
                            <div Class="row">
                                ...
                                <div class="mb-3 col flex-fill <?php echo e($specialtys); ?>">
                                    <div class="form-floating form-floating-outline">
                                      <select wire:model.defer='specialtys_code'   id="modalPrecisesspecialtys_code" class="form-select <?php $__errorArgs = ['specialtys_code'];
...
unset($__errorArgs, $__bag); ?>">
                                      <option value=""></option>
                                        ...
                                        <option value="<?php echo e($specialty->id); ?>"><?php echo e($specialty-> specialtys_name); ?></option>
...
<!--/ Add Precise Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/precises/modals/add-precise.blade.php ENDPATH**/ ?>