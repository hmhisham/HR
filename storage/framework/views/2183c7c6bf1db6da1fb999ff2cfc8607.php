...
} elseif ($_instance->childHasBeenRendered('MDSr6kr')) {
    $componentId = $_instance->getRenderedChildComponentId('MDSr6kr');
    $componentTag = $_instance->getRenderedChildComponentTagName('MDSr6kr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MDSr6kr');
} else {
    $response = \Livewire\Livewire::mount('users.administrators-accounts.administrators-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('MDSr6kr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/content/Users/AdministratorsAccounts/index.blade.php ENDPATH**/ ?>