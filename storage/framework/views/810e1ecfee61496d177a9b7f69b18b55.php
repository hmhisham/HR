...
} elseif ($_instance->childHasBeenRendered('MIJfWhw')) {
    $componentId = $_instance->getRenderedChildComponentId('MIJfWhw');
    $componentTag = $_instance->getRenderedChildComponentTagName('MIJfWhw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MIJfWhw');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.permissions.account-permissions');
    $html = $response->html();
    $_instance->logRenderedChild('MIJfWhw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
