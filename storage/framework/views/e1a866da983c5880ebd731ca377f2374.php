...
} elseif ($_instance->childHasBeenRendered('kvnYjcZ')) {
    $componentId = $_instance->getRenderedChildComponentId('kvnYjcZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('kvnYjcZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kvnYjcZ');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.permissions.account-permissions');
    $html = $response->html();
    $_instance->logRenderedChild('kvnYjcZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel 2024\HR\HR\resources\views/content/Owner/Permission&Roles/Permissions/index.blade.php ENDPATH**/ ?>