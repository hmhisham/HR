...
} elseif ($_instance->childHasBeenRendered('NRjBGC6')) {
    $componentId = $_instance->getRenderedChildComponentId('NRjBGC6');
    $componentTag = $_instance->getRenderedChildComponentTagName('NRjBGC6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NRjBGC6');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.permissions.account-permissions');
    $html = $response->html();
    $_instance->logRenderedChild('NRjBGC6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
