...
} elseif ($_instance->childHasBeenRendered('oCMdEX7')) {
    $componentId = $_instance->getRenderedChildComponentId('oCMdEX7');
    $componentTag = $_instance->getRenderedChildComponentTagName('oCMdEX7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oCMdEX7');
} else {
    $response = \Livewire\Livewire::mount('scalems.scalem');
    $html = $response->html();
    $_instance->logRenderedChild('oCMdEX7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
