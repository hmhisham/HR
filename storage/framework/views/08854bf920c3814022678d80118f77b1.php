...
} elseif ($_instance->childHasBeenRendered('BLGGjRz')) {
    $componentId = $_instance->getRenderedChildComponentId('BLGGjRz');
    $componentTag = $_instance->getRenderedChildComponentTagName('BLGGjRz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BLGGjRz');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.roles.account-roles');
    $html = $response->html();
    $_instance->logRenderedChild('BLGGjRz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\HR\resources\views/content/Owner/Permission&Roles/Roles/index.blade.php ENDPATH**/ ?>