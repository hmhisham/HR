...
} elseif ($_instance->childHasBeenRendered('EH433Zg')) {
    $componentId = $_instance->getRenderedChildComponentId('EH433Zg');
    $componentTag = $_instance->getRenderedChildComponentTagName('EH433Zg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EH433Zg');
} else {
    $response = \Livewire\Livewire::mount('units.unit');
    $html = $response->html();
    $_instance->logRenderedChild('EH433Zg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
