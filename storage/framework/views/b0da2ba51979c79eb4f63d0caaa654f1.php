...
} elseif ($_instance->childHasBeenRendered('Tj2LVuB')) {
    $componentId = $_instance->getRenderedChildComponentId('Tj2LVuB');
    $componentTag = $_instance->getRenderedChildComponentTagName('Tj2LVuB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Tj2LVuB');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.permissions.account-permissions');
    $html = $response->html();
    $_instance->logRenderedChild('Tj2LVuB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HISHAM\Desktop\HR\HR\resources\views/content/Owner/Permission&Roles/Permissions/index.blade.php ENDPATH**/ ?>