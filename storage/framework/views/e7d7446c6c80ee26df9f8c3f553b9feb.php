        ...
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">حذف القسم</h3>
                    <p>نافذة الحذف</p>
                </div>
                <hr class="mt-n2">
                        ...
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <div class="text-danger">
                                    ...
                                    <div class="form-control-plaintext mt-n2"><?php echo e($section_name); ?></div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\11\Desktop\HR\resources\views/livewire/sections/modals/remove-section.blade.php ENDPATH**/ ?>