                    ...
                    <form id="editSectionModalForm" autocomplete="off">
                        <div class="row row-cols-1">
                            <div class="col mb-3">
                                ...
                                <div class="mb-3 col flex-fill <?php echo e($links); ?>">
                                    <div class="form-floating form-floating-outline">
                                        <select wire:model.defer='link_id' id="modalSectionslink_id"
                                            class="form-select <?php $__errorArgs = ['link_id'];
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($link->id); ?>"><?php echo e($link->link_name); ?></option>
...
<!--/ Edite Section Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/sections/modals/edit-section.blade.php ENDPATH**/ ?>