...
} elseif ($_instance->childHasBeenRendered('HxfVcXX')) {
    $componentId = $_instance->getRenderedChildComponentId('HxfVcXX');
    $componentTag = $_instance->getRenderedChildComponentTagName('HxfVcXX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HxfVcXX');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.roles.account-roles');
    $html = $response->html();
    $_instance->logRenderedChild('HxfVcXX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HISHAM\Desktop\HR\HR\resources\views/content/Owner/Permission&Roles/Roles/index.blade.php ENDPATH**/ ?>