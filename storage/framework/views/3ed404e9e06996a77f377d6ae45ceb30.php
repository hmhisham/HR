...
} elseif ($_instance->childHasBeenRendered('QfrGZy7')) {
    $componentId = $_instance->getRenderedChildComponentId('QfrGZy7');
    $componentTag = $_instance->getRenderedChildComponentTagName('QfrGZy7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QfrGZy7');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.roles.account-roles');
    $html = $response->html();
    $_instance->logRenderedChild('QfrGZy7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement-Copy\resources\views/content/Owner/Permission&Roles/Roles/index.blade.php ENDPATH**/ ?>