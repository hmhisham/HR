...
<!-- Remove Worker Modal -->
<div wire:ignore.self class="modal fade" id="removeworkerModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <form id="removeWorkerModalForm" onsubmit="return false" autocomplete="off">
                        ...
                        <div class="col mb-3">
                         <Div Class="row">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='id' type="text" id="modalWorkerid" placeholder=""
...
<!--/ Delete Worker Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/workers/modals/remove-worker.blade.php ENDPATH**/ ?>