            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <?php $i++; ?>
                        <td><?php echo e($i); ?></td>
                        <td class="text-center"><?php echo e($Holiday->worker ? $Holiday->worker->full_name : 'N/A'); ?></td>
                        <td class="text-center"><?php echo e($Holiday->worker ? $Holiday->worker->department : 'N/A'); ?></td>
