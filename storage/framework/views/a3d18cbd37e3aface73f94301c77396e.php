...
<?php $__env->startSection('content'); ?>
    ...
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('events.create-events')->html();
} elseif ($_instance->childHasBeenRendered('ItziXUE')) {
    $componentId = $_instance->getRenderedChildComponentId('ItziXUE');
    $componentTag = $_instance->getRenderedChildComponentTagName('ItziXUE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ItziXUE');
} else {
    $response = \Livewire\Livewire::mount('events.create-events');
    $html = $response->html();
    $_instance->logRenderedChild('ItziXUE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->startSection('page-script'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            window.initCategoriesDrop=()=>{
                $('#Categories').select2({
                    placeholder: 'حدد نوع التسديد' ,
                    dropdownParent: $('#addStatementModal')
                })
            }
            initCategoriesDrop();
            $('#Categories').on('change', function (e) {
                livewire.emit('SelectCategories', e.target.value)
            });
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/content/Events/Events/create.blade.php ENDPATH**/ ?>