<!-- Edite Coache Modal -->
<div wire:ignore.self class="modal fade" id="editcoacheModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <h5 wire:loading wire:target="GetCoache"
                    wire:loading.class="d-flex justify-content-center text-primary">جار معالجة البيانات...</h5>
                <h5 wire:loading wire:target="update" wire:loading.class="d-flex justify-content-center text-primary">
                    جار حفظ البيانات...</h5>

                <div wire:loading.remove>
                    <form id="editCoacheModalForm" autocomplete="off">
                        <div class="row row-cols-1">
                            <div class="col mb-3">
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='name_coache' type="text"
                                                id="modalCoachename_coache" placeholder="اسم المدرب"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <select wire:model.defer="education" id="modalCoacheeducation" class="form-select <?php $__errorArgs = ['education'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div Class="row">
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='institution' type="text"
                                                id="modalCoacheinstitution" placeholder="مؤسسة المدرب"
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='training_field' type="text"
                                                ...
                                                class="form-control <?php $__errorArgs = ['training_field'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid is-filled <?php unset($message);
...
<!--/ Edite Coache Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/coaches/modals/edit-coache.blade.php ENDPATH**/ ?>