                    ...
                    <div class="row row-cols-1  ">
                        ...
                        <div Class="row">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='governorate_id' type="text" id="modalAreasgovernorate_id" placeholder="رقم المحافظة"
...
unset($__errorArgs, $__bag); ?>" />
                                        <label for="modalAreasgovernorate_id">رقم المحافظة</label>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='district_id' type="text" id="modalAreasdistrict_id" placeholder="رقم القضاء"
...
unset($__errorArgs, $__bag); ?>" />
                                        <label for="modalAreasdistrict_id">رقم القضاء</label>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='area_id' type="text" id="modalAreasarea_id" placeholder="رقم الناحية"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='area_name' type="text" id="modalAreasarea_name" placeholder="اسم الناحية"
...
<!--/ Add Area Modal -->
<?php /**PATH C:\Users\HISHAM\Desktop\HR\HR\resources\views/livewire/areas/modals/add-area.blade.php ENDPATH**/ ?>