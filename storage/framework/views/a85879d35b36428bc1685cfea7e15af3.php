...
} elseif ($_instance->childHasBeenRendered('5EO1CWu')) {
    $componentId = $_instance->getRenderedChildComponentId('5EO1CWu');
    $componentTag = $_instance->getRenderedChildComponentTagName('5EO1CWu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5EO1CWu');
} else {
    $response = \Livewire\Livewire::mount('emp-info-bank.add-employee');
    $html = $response->html();
    $_instance->logRenderedChild('5EO1CWu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\HR\resources\views/content/EmpInfoBank/addEmployee.blade.php ENDPATH**/ ?>