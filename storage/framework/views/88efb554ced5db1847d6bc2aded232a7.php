...
<?php if(isset($navbarDetached) && $navbarDetached == ''): ?>
				...
				<div class="py-0 navbar-brand app-brand demo d-none d-xl-flex me-4">
					<a href="<?php echo e(url('/')); ?>" class="gap-2 app-brand-link">
						<span class="app-brand-logo demo">
							<?php echo $__env->make('_partials.macros',["width"=>25,"withbg"=>'#666cff'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						</span>
							...
							<div class="dropdown-shortcuts-list scrollable-container">
								...
								<div class="overflow-visible row row-bordered g-0">
									...
									<div class="dropdown-shortcuts-item col">
										...
										<a href="<?php echo e(url('pages/account-settings-account')); ?>"
								...
								<div class="overflow-visible row row-bordered g-0">
									<div class="dropdown-shortcuts-item col">
										...
										<a href="<?php echo e(url('pages/help-center-landing')); ?>" class="stretched-link">Help
											Center</a>
								...
								<ul class="list-group list-group-flush">
									...
									<li
										...
										<div class="gap-2 d-flex">
											<div class="flex-shrink-0">
												<div class="avatar me-1">
													<img src="<?php echo e(asset('assets/img/avatars/2.png')); ?>" alt
									...
									<li
										...
										<div class="gap-2 d-flex">
											<div class="flex-shrink-0">
												<div class="avatar me-1">
													<img src="<?php echo e(asset('assets/img/avatars/9.png')); ?>" alt
														class="h-auto w-px-40 rounded-circle">
												</div>
											</div>
											<div class="overflow-hidden d-flex flex-column flex-grow-1 w-px-200">
									...
									<li
										...
										<div class="gap-2 d-flex">
											<div class="flex-shrink-0">
												<div class="avatar me-1">
													<img src="<?php echo e(asset('assets/img/avatars/5.png')); ?>" alt
														class="h-auto rounded-circle">
												</div>
											</div>
											<div class="overflow-hidden d-flex flex-column flex-grow-1 w-px-200">
									...
									<li class="list-group-item list-group-item-action dropdown-notifications-item">
										<div class="gap-2 d-flex">
											<div class="flex-shrink-0">
												<div class="avatar me-1">
													<img src="<?php echo e(asset('assets/img/avatars/6.png')); ?>" alt
														class="h-auto rounded-circle">
												</div>
											</div>
											<div class="overflow-hidden d-flex flex-column flex-grow-1 w-px-200">
												...
												<?php if(Auth::check()): ?>
													...
													<div>
														<?php
															...
															$disease = '';
														?>
														<?php $__currentLoopData = Auth::user()->getRoleNames(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<!-- / Navbar -->
<?php /**PATH F:\LaravelProjects\JAZContentManagement-Copy\resources\views/layouts/sections/navbar/navbar.blade.php ENDPATH**/ ?>