<?php $__env->startSection('title', 'title index'); ?>
...
} elseif ($_instance->childHasBeenRendered('Os7I5bD')) {
    $componentId = $_instance->getRenderedChildComponentId('Os7I5bD');
    $componentTag = $_instance->getRenderedChildComponentTagName('Os7I5bD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Os7I5bD');
} else {
    $response = \Livewire\Livewire::mount('employees.employee');
    $html = $response->html();
    $_instance->logRenderedChild('Os7I5bD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
