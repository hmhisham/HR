<!-- Remove Grade Modal -->
<div wire:ignore.self class="modal fade" id="removegradeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="p-4 modal-content p-md-5">
            <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">حذف الدرجة</h3>
                    <p>نافذة الحذف</p>
                </div>
                <hr class="mt-n2">
                ...
                <div wire:loading.remove>
                    <form id="removeGradeModalForm" onsubmit="return false" autocomplete="off">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:model.defer='grades_name' type="text"
                                                id="modalGradegrades_name" placeholder="اسم الدرجة"
...
unset($__errorArgs, $__bag); ?>"
                                                disabled />
                                            <label for="modalGradegrades_name">اسم الدرجة</label>
                                        </div>
...
<!--/ Delete Grade Modal -->
<?php /**PATH C:\Users\11\Desktop\HR\resources\views/livewire/grades/modals/remove-grade.blade.php ENDPATH**/ ?>