...
} elseif ($_instance->childHasBeenRendered('sMCZ9bR')) {
    $componentId = $_instance->getRenderedChildComponentId('sMCZ9bR');
    $componentTag = $_instance->getRenderedChildComponentTagName('sMCZ9bR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sMCZ9bR');
} else {
    $response = \Livewire\Livewire::mount('thanks.thank');
    $html = $response->html();
    $_instance->logRenderedChild('sMCZ9bR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
