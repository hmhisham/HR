...
} elseif ($_instance->childHasBeenRendered('of2wIoS')) {
    $componentId = $_instance->getRenderedChildComponentId('of2wIoS');
    $componentTag = $_instance->getRenderedChildComponentTagName('of2wIoS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('of2wIoS');
} else {
    $response = \Livewire\Livewire::mount('users.administrators-accounts.administrators-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('of2wIoS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement-Copy\resources\views/content/Users/AdministratorsAccounts/index.blade.php ENDPATH**/ ?>