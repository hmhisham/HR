                ...
                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', ['OWNER', 'Administrator', 'Supervisor', 'Employee'])): ?>
                    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                        ...
                        <ul class="py-1 menu-inner">
                            ...
                            <li
                                class="menu-item <?php echo e(request()->is('Governorates', 'Districts', 'Areas', 'Infooffice', 'Links', 'Sections', 'Branch', 'Units', 'Certificates', 'Graduations', 'Specializations', 'Specialtys', 'Precises', 'Grades', 'Jobtitles', 'Scales') ? 'open active' : ''); ?>">
                                ...
                                <ul class="menu-sub">
                                    ...
                                    <li Class="menu-item <?php echo e(request()->Is('Scales') ? 'active' : ''); ?>">
                                        <a href = "<?php echo e(Route('Scales.index')); ?>" Class="menu-link">
                                            <i Class=''></i>
                                    ...
                                    <li
                                        ...
                                        <ul class="menu-sub">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles')): ?>
                                                <li
                                                    class="menu-item <?php echo e(request()->is('Permissions&Roles/Account-Roles') ? 'active' : ''); ?>">
...
<?php echo $__env->make('layouts/commonMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel 2024\HR\HR\resources\views/layouts/contentNavbarLayout.blade.php ENDPATH**/ ?>