...
} elseif ($_instance->childHasBeenRendered('JC4IuQg')) {
    $componentId = $_instance->getRenderedChildComponentId('JC4IuQg');
    $componentTag = $_instance->getRenderedChildComponentTagName('JC4IuQg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JC4IuQg');
} else {
    $response = \Livewire\Livewire::mount('users.customers-accounts.customers-accounts');
    $html = $response->html();
    $_instance->logRenderedChild('JC4IuQg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HISHAM\Desktop\HR\HR\resources\views/content/Users/CustomersAccounts/index.blade.php ENDPATH**/ ?>