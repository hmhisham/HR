<div class="mt-n4">
    <h4 class="mb-2">
        <span class="text-muted fw-light">الاحداث /</span><span> انشاء حدث </span>
    </h4>
        ...
        <div wire:ignore id="sticky-wrapper" class="sticky-wrapper">
            <div class="sticky-element card px-3 py-0 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                <div class="d-flex flex-column justify-content-center">
                    <h4 class="mb-1 mt-3">انشاء حدث جديد</h4>
                ...
                <div class="d-flex align-content-center flex-wrap gap-3">
                    ...
                    <button wire:click="SavePublishDraft('draft')" class="btn btn-outline-primary">حفظ المسودة</button>
                    <button wire:click="SavePublishDraft('publish')" class="btn btn-primary">نشر الحدث</button>
                </div>
            </div>
        </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3">
                                    <div class="w-25 d-flex justify-content-end">
                                        <label class="switch switch-primary">
                                            <input wire:model.defer="Active" type="checkbox" class="switch-input" >
                                    ...
                                    <div wire:loading.remove wire:target="photo" class="">
                                        <?php if($photo): ?>
                                            <div class="d-flex align-items-center flex-column align-self-center" style="height: 190px!important;">
                                                <img src="<?php echo e($photo->temporaryUrl()); ?>" class="fit-content">
                                            </div>
                                            ...
                                            <div class="badge <?php echo e($Size > 10 ? 'bg-label-danger':'bg-label-success'); ?>" style="position: absolute; left: 15%; top: 80%">حجم الصورة: <?php echo e($photoSize); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <input wire:model="photo" type="file" id="images" accept="image/.jpg,.jpeg,.png" style="display: none">
                            </div>
                        </label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card p-2 h-100 shadow-none border">
                            <div class="rounded-2 text-center mb-3" style="height: 200px!important; width: 100%!important;">
                                <?php if($photo): ?>
                                    <img src="<?php echo e($photo->temporaryUrl()); ?>" class="fit-content img-fluid rounded" alt="event image">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('assets/img/logo/event-logo.jpg')); ?>" class="fit-content img-fluid rounded" alt="event image"/>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="card-body <?php echo e($PreviewLayout == 'ar' ? '':'hidden'); ?> p-3 pt-2" style="text-align: right; direction: rtl;">
                                ...
                                <?php
                                    $wProgress = 'progress-' . $progressDaysBaforeEvent;
                                ?>

                                

                                <progress class="progress-bar rounded-pill w-100" value="<?php echo e($progressDaysBaforeEvent); ?>" max="<?php echo e($progressDaysBaforeEvent); ?>" style="height: 8px"></progress>
                            ...
                            <div class="card-body <?php echo e($PreviewLayout == 'en' ? '':'hidden'); ?> p-3 pt-2" style="text-align: left; direction: ltr;">
                                ...
                                <div class="progress rounded-pill mb-3" style="height: 8px">
                                    <div class="progress-bar <?php echo e($wProgress); ?>" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="<?php echo e($progressDaysBaforeEvent); ?>"></div>
                                </div>
...
<?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/livewire/events/create-events.blade.php ENDPATH**/ ?>