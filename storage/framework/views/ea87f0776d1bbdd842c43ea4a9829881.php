<?php $__env->startSection('title', 'لوحة متابعة الاحداث'); ?>
...
<?php $__env->startSection('page-script'); ?>
    <script src="<?php echo e(asset('assets/js/app-academy-dashboard.js')); ?>"></script>
<?php $__env->stopSection(); ?>
                    ...
                    <table class="table table-borderless border-top">
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center mt-lg-4">
                                    <div class="avatar avatar-sm me-3">
                                        <img src="<?php echo e(asset('assets/img/avatars/1.png')); ?>" alt="Avatar"
                        ...
                        <tr>
                            <td>
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="avatar avatar-sm me-3">
                                        <img src="<?php echo e(asset('assets/img/avatars/2.png')); ?>" alt="Avatar"
                                             class="rounded-circle"/>
                                    </div>
                                    <div class="d-flex flex-column">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="avatar avatar-sm me-3">
                                        <img src="<?php echo e(asset('assets/img/avatars/3.png')); ?>" alt="Avatar"
                                             class="rounded-circle"/>
                                    </div>
                                    <div class="d-flex flex-column">
                        ...
                        <tr>
                            <td>
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="avatar avatar-sm me-3">
                                        <img src="<?php echo e(asset('assets/img/avatars/4.png')); ?>" alt="Avatar"
                                             class="rounded-circle"/>
                                    </div>
                                    <div class="d-flex flex-column">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-primary"><i
                                        class="mdi mdi-video-outline mdi-24px"></i></span>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-info"><i
                                        class="mdi mdi-code-tags mdi-24px"></i></span>
                            </div>
                            <div class="row w-100 align-items-center">
                                <div class="col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-success"><i
                                        class="mdi mdi-camera-image mdi-24px"></i></span>
                            </div>
                            <div class="row w-100 align-items-center">
                                <div class="col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
                        ...
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-warning"><i
                                        class="mdi mdi-palette-outline mdi-24px"></i></span>
                            </div>
                            <div class="row w-100 align-items-center">
                                <div class="col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
                        ...
                        <li class="d-flex">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-danger"><i
                                        class="mdi mdi-microphone mdi-24px"></i></span>
                            </div>
                            <div class="row w-100 align-items-center">
                                <div class="col-sm-8 col-lg-12 col-xxl-8 mb-1 mb-sm-0 mb-lg-1 mb-xxl-0">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="bg-label-info text-center mb-3 pt-2 rounded-3">
                        <img class="img-fluid" src="<?php echo e(asset('assets/img/illustrations/card-ratings-illustration.png')); ?>"
        ...
        <div class="col-12 col-xl-4 col-md-6">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="assignProgress" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-dots-vertical mdi-24px"></i>
                        </button>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/content/Events/EventsDashboard/index.blade.php ENDPATH**/ ?>