                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customers')): ?>
                                <li class="menu-item <?php echo e(request()->is('Customers') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(Route('Customers')); ?>" class="menu-link">
                                        ...
                                        <div><?php echo e(trans('sidebar.customers')); ?></div>
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events')): ?>
                                <li class="menu-item <?php echo e(request()->is('EventsDashboard', 'Events', 'Events/create', 'Events/*/edit') ? 'active open' :  ''); ?>">
                                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-title"><?php echo e(trans('sidebar.events')); ?></span>
                                    </a>
                                    <ul class="menu-sub">
                                        <li class="menu-item <?php echo e(request()->is('EventsDashboard') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(Route('EventsDashboard')); ?>" class="menu-link">
                                                <i class=""></i>
                                                <div><?php echo e(trans('sidebar.events-dashboard')); ?></div>
                                            </a>
                                        </li>
                                        <li class="menu-item <?php echo e(request()->is('Events') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(Route('Events.index')); ?>" class="menu-link">
                                                <i class=""></i>
                                                <div><?php echo e(trans('sidebar.all events')); ?></div>
                                            </a>
                                        </li>
                                        <li class="menu-item <?php echo e(request()->is('PublishedEvents') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(Route('PublishedEvents')); ?>" class="menu-link">
                                                <i class=""></i>
                                                <div><?php echo e(trans('sidebar.published events')); ?></div>
                                            </a>
                                        </li>
                                        <li class="menu-item <?php echo e(request()->is('DraftEvents') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(Route('DraftEvents')); ?>" class="menu-link">
                                                <i class=""></i>
                                                <div><?php echo e(trans('sidebar.draft events')); ?></div>
                                            </a>
                                        </li>
                                        <li class="menu-item <?php echo e(request()->is('Events/create') ? 'active' : 'hidden'); ?>">
                                            <a href="<?php echo e(Route('Events.create')); ?>" class="menu-link">
                                                <i class=""></i>
                                                <div><?php echo e(trans('sidebar.create new event')); ?></div>
                                            </a>
                                        </li>
                                        <li class="menu-item <?php echo e(request()->is('Events/*/edit') ? 'active' : 'hidden'); ?>">
                                            <a href="javascript:void(0)" class="menu-link">
                                                <i class=""></i>
                                                <div><?php echo e(trans('sidebar.edit event')); ?></div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
...
<?php echo $__env->make('layouts/commonMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\LaravelProjects\JAZContentManagement\resources\views/layouts/contentNavbarLayout.blade.php ENDPATH**/ ?>
