...
<!-- Add Linkage Modal -->
<div wire:ignore.self class="modal fade" id="addlinkageModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="p-4 modal-content p-md-5">
            ...
            <div class="modal-body p-md-0">
                ...
                <hr class="mt-n2">
                <form id="addlinkageModalForm" autocomplete="off">
...
<!--/ Add Linkage Modal -->
<?php /**PATH D:\Laravel 2024\HR\HR\resources\views/livewire/linkages/modals/add-linkage.blade.php ENDPATH**/ ?>