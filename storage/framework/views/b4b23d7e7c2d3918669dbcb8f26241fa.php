...
} elseif ($_instance->childHasBeenRendered('Lhkq9ID')) {
    $componentId = $_instance->getRenderedChildComponentId('Lhkq9ID');
    $componentTag = $_instance->getRenderedChildComponentTagName('Lhkq9ID');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Lhkq9ID');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.permissions.account-permissions');
    $html = $response->html();
    $_instance->logRenderedChild('Lhkq9ID', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\HR\resources\views/content/Owner/Permission&Roles/Permissions/index.blade.php ENDPATH**/ ?>