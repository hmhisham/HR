...
} elseif ($_instance->childHasBeenRendered('ZJK4Lz7')) {
    $componentId = $_instance->getRenderedChildComponentId('ZJK4Lz7');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZJK4Lz7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZJK4Lz7');
} else {
    $response = \Livewire\Livewire::mount('owner.permissions-roles.permissions.account-permissions');
    $html = $response->html();
    $_instance->logRenderedChild('ZJK4Lz7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
