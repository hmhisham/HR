            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <?php $i++; ?>
                        <td><?php echo e($i); ?></td>
                        <td class="text-center"><?php echo e($Certifi->worker ? $Certifi->worker->full_name : 'N/A'); ?></td>
                        <td class="text-center"><?php echo e($Certifi->worker ? $Certifi->worker->department : 'N/A'); ?></td>
